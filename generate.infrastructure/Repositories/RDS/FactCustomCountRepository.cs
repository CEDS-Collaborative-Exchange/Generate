    ...
    public class FactCustomCountRepository : RDSRepository, IFactCustomCountRepository
    {
        ...
        public IEnumerable<FactCustomCount> Get_ReportData(string reportCode, string reportLevel, string reportYear, string categorySetCode, bool includeFriendlyCaptions = false, bool obscureMissingCategoryCounts = false)
        {
            ...
            try
            {
                ...
                returnObject = _context.Set<FactCustomCount>().FromSqlRaw("rds.Get_ReportData @reportCode = {0}, @reportLevel = {1}, @reportYear = {2}, @categorySetCode = {3}, @includeFriendlyCaptions = {4}, @obscureMissingCategoryCounts = {5}", reportCode, reportLevel, reportYear, categorySetCode, friendlyCaptions, missingCategoryCounts).ToList();
