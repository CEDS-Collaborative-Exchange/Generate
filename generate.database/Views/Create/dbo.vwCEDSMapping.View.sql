...
CROSS APPLY app.fnSplit(CAST(m.Value AS VARCHAR(MAX)), ',') ms
CROSS APPLY app.fnSplit(CAST(e.Value AS VARCHAR(MAX)), ',') es
CROSS APPLY app.fnSplit(CAST(u.Value AS VARCHAR(MAX)), ',') us
