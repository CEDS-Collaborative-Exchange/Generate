...
AS
	...
	JOIN [RDS].[DimLeas] lea on lea.LeaIdentifierSea = lea.SeaOrganizationIdentifierSea
	...
	WHERE el.LeaIdentifierSea IS NULL
		...
		AND pt.ProgramParticipationBeginDate >= CAST(('7/1/' + CAST((vw.SchoolYear -1) as varchar))  AS Date)
