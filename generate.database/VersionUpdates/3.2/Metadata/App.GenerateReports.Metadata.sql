...
begin try
	...
	begin transaction
		...
		BEGIN
			...
			UPDATE app.GenerateReports SET ReportName ='C156: CTE Concentrators in Programs for Non-Traditional',	ReportShortName = 'C156' , IsActive ='1' WHERE GenerateReportId = @GenerateReportId
		END
