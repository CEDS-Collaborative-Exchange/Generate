...
IF(@reportCode = 'c029')
	BEGIN
		...
		left outer join rds.DimLeas leaDir on fact.LEAType = leaDir.LeaTypeEdFactsCode and fact.OrganizationId = leaDir.LeaOrganizationId
		left outer join rds.DimSchools schDir on fact.SchoolType = schDir.SchoolTypeEdFactsCode and fact.OrganizationId = schDir.SchoolOrganizationId
