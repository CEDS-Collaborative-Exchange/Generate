...
BEGIN
	...
	inner join ods.OrganizationPersonRole r on p.PersonId = r.PersonId and r.RoleId = @studentRoleId
	inner join ods.K12StudentAcademicRecord a on a.OrganizationPersonRoleId=r.OrganizationPersonRoleId
	left join (
		select distinct 
			s.DimStudentId, 
			r2.PersonId, 
