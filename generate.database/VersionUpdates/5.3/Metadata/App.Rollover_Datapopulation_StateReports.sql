...
select @latestSubmissionYear = max(SubmissionYear) from rds.DimDates
select @lastSubmissionYear = max(SubmissionYear) from rds.DimDates where SubmissionYear <> @latestSubmissionYear
