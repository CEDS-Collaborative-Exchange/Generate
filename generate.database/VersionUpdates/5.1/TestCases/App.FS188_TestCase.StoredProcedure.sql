CREATE OR ALTER PROCEDURE [App].[FS188_TestCase]	
	@SchoolYear SMALLINT
AS
BEGIN
...
BEGIN TRY
	...
	DECLARE @UnitTestName VARCHAR(100) = 'FS188_UnitTestCase'
	DECLARE @AssessmentAcademicSubject VARCHAR(10) = '13373' 
	DECLARE @StoredProcedureName VARCHAR(100) = 'FS188_TestCase'
	DECLARE @TestScope VARCHAR(1000) = 'FS188'
	DECLARE @ReportCode VARCHAR(20) = 'C188' 
