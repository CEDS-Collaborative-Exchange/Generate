...
BEGIN
	...
	left outer join @attendanceQuery att on s.DimStudentId = att.DimStudentId and s.DimCountDateId = att.DimCountDateId and sch.DimSchoolId = att.DimSchoolId and sch.DimLeaId = att.DimLeaId and sch.DimSeaId = att.DimSeaId
