...
FROM @personnelDates s
	...
	inner join ods.OrganizationIdentifier oi on o.OrganizationId = oi.OrganizationId and oi.RefOrganizationIdentificationSystemId = @schoolSEAIdentificationSystemId
	...
	Left join (SELECT LangInst.OrganizationId, LangInst.RefTitleIIILanguageInstructionProgramTypeId, progType.Code  
				...
				inner join ods.RefTitleIIILanguageInstructionProgramType progType 
