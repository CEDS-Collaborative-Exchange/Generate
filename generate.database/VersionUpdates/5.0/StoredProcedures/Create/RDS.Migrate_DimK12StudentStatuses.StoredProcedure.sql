...
BEGIN
    ...
    FROM dbo.OrganizationPersonRole opr
        ...
        LEFT JOIN dbo.WorkforceEmploymentQuarterlyData emp
            ON opr.OrganizationPersonRoleId = emp.OrganizationPersonRoleId -- Military & Employment
        ...
        LEFT JOIN dbo.PsStudentEnrollment psEnrll
            ON opr.OrganizationPersonRoleId = psEnrll.[OrganizationPersonRoleId] ---Postsecondary Education
        LEFT JOIN dbo.K12StudentAcademicRecord diploma
            ON opr.OrganizationPersonRoleId = diploma.[OrganizationPersonRoleId];
    ...
    FROM @studentDates s
        ...
        JOIN dbo.OrganizationPersonRole r
            ON r.PersonId = s.PersonId
               AND r.OrganizationId = IIF(org.K12SchoolOrganizationId > 0,
        ...
        LEFT JOIN dbo.OrganizationRelationship ore
            ON r.OrganizationId = ore.Parent_OrganizationId
        LEFT JOIN dbo.OrganizationPersonRole mopr
            ON ore.OrganizationId = mopr.OrganizationId
               AND mopr.PersonId = r.PersonId
        LEFT JOIN dbo.PersonProgramParticipation ppp
            ON ppp.OrganizationPersonRoleId = mopr.OrganizationPersonRoleId
        ...
        LEFT JOIN dbo.K12StudentAcademicRecord sa
            ON sa.OrganizationPersonRoleId = r.OrganizationPersonRoleId
