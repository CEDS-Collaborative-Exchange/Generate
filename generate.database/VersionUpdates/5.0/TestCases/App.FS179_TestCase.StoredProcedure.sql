CREATE OR ALTER PROCEDURE [App].[FS179_TestCase]	
	@SchoolYear SMALLINT
AS
BEGIN
...
BEGIN TRY
	...
	DECLARE @UnitTestName VARCHAR(100) = 'FS179_UnitTestCase'
	DECLARE @AssessmentAcademicSubject VARCHAR(10) = '00562' 
	DECLARE @StoredProcedureName VARCHAR(100) = 'FS179_TestCase'
	DECLARE @TestScope VARCHAR(1000) = 'FS179'
	DECLARE @ReportCode VARCHAR(20) = 'C179' 
