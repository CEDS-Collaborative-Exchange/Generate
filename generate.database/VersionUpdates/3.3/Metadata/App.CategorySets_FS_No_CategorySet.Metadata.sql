...
begin try
	...
	begin transaction
		...
		VALUES
		(@GenerateReportId, @schId, 0, '2018-19', 'CategorySetA', 'Category Set A')
		...
		IF NOT EXISTS (SELECT 1 FROM [App].[Categories] WHERE [CategoryCode] = 'ComprehensiveSupportIdentificationTypeID')
							INSERT INTO [App].[Categories] 
								([CategoryCode] ,[CategoryName], [EdFactsCategoryId])		
								VALUES ('ComprehensiveSupportIdentificationTypeID','Additional targeted support school not exiting suc', 0)
		...
		IF NOT EXISTS (SELECT 1 FROM [App].[Categories] WHERE [CategoryCode] = 'ComprehensiveSupportIdentificationTypeID')
							INSERT INTO [App].[Categories] 
								([CategoryCode] ,[CategoryName], [EdFactsCategoryId])		
								VALUES ('ComprehensiveSupportIdentificationTypeID','Low graduation rate high school', 0)
		SELECT @CategoryId = CategoryId FROM App.Categories Where CategoryCode = 'ComprehensiveSupportIdentificationTypeID'
		...
		IF NOT EXISTS (SELECT 1 FROM [App].[Categories] WHERE [CategoryCode] = 'ComprehensiveSupportIdentificationTypeID')
							INSERT INTO [App].[Categories] 
								([CategoryCode] ,[CategoryName], [EdFactsCategoryId])		
								VALUES ('ComprehensiveSupportIdentificationTypeID','Lowest-performing school', 0)
		SELECT @CategoryId = CategoryId FROM App.Categories Where CategoryCode = 'ComprehensiveSupportIdentificationTypeID'
		...
		IF NOT EXISTS (SELECT 1 FROM [App].[Categories] WHERE [CategoryCode] = 'ComprehensiveSupportIdentificationTypeID')
							INSERT INTO [App].[Categories] 
								([CategoryCode] ,[CategoryName], [EdFactsCategoryId])		
								VALUES ('ComprehensiveSupportIdentificationTypeID','Missing', 0)
		SELECT @CategoryId = CategoryId FROM App.Categories Where CategoryCode = 'ComprehensiveSupportIdentificationTypeID'
		...
		IF NOT EXISTS (SELECT 1 FROM [App].[Categories] WHERE [CategoryCode] = 'ComprehensiveTargetedSupportSchTypeID')
							INSERT INTO [App].[Categories] 
								([CategoryCode] ,[CategoryName], [EdFactsCategoryId])		
								VALUES ('ComprehensiveTargetedSupportSchTypeID','Comprehensive Support and Improvement', 0)
		...
		IF NOT EXISTS (SELECT 1 FROM [App].[Categories] WHERE [CategoryCode] = 'ComprehensiveTargetedSupportSchTypeID')
							INSERT INTO [App].[Categories] 
								([CategoryCode] ,[CategoryName], [EdFactsCategoryId])		
								VALUES ('ComprehensiveTargetedSupportSchTypeID','Comprehensive Support and Improvement – Exit Statu', 0)
		SELECT @CategoryId = CategoryId FROM App.Categories Where CategoryCode = 'ComprehensiveTargetedSupportSchTypeID'
		...
		IF NOT EXISTS (SELECT 1 FROM [App].[Categories] WHERE [CategoryCode] = 'ComprehensiveTargetedSupportSchTypeID')
							INSERT INTO [App].[Categories] 
								([CategoryCode] ,[CategoryName], [EdFactsCategoryId])		
								VALUES ('ComprehensiveTargetedSupportSchTypeID','Missing', 0)
		SELECT @CategoryId = CategoryId FROM App.Categories Where CategoryCode = 'ComprehensiveTargetedSupportSchTypeID'
		...
		IF NOT EXISTS (SELECT 1 FROM [App].[Categories] WHERE [CategoryCode] = 'ComprehensiveTargetedSupportSchTypeID')
							INSERT INTO [App].[Categories] 
								([CategoryCode] ,[CategoryName], [EdFactsCategoryId])		
								VALUES ('ComprehensiveTargetedSupportSchTypeID','Not Comprehensive Support and Improvement or Targe', 0)
		SELECT @CategoryId = CategoryId FROM App.Categories Where CategoryCode = 'ComprehensiveTargetedSupportSchTypeID'
		...
		IF NOT EXISTS (SELECT 1 FROM [App].[Categories] WHERE [CategoryCode] = 'ComprehensiveTargetedSupportSchTypeID')
							INSERT INTO [App].[Categories] 
								([CategoryCode] ,[CategoryName], [EdFactsCategoryId])		
								VALUES ('ComprehensiveTargetedSupportSchTypeID','Small school', 0)
		SELECT @CategoryId = CategoryId FROM App.Categories Where CategoryCode = 'ComprehensiveTargetedSupportSchTypeID'
		...
		IF NOT EXISTS (SELECT 1 FROM [App].[Categories] WHERE [CategoryCode] = 'ComprehensiveTargetedSupportSchTypeID')
							INSERT INTO [App].[Categories] 
								([CategoryCode] ,[CategoryName], [EdFactsCategoryId])		
								VALUES ('ComprehensiveTargetedSupportSchTypeID','Targeted Support and Improvement', 0)
		SELECT @CategoryId = CategoryId FROM App.Categories Where CategoryCode = 'ComprehensiveTargetedSupportSchTypeID'
		...
		IF NOT EXISTS (SELECT 1 FROM [App].[Categories] WHERE [CategoryCode] = 'ComprehensiveTargetedSupportSchTypeID')
							INSERT INTO [App].[Categories] 
								([CategoryCode] ,[CategoryName], [EdFactsCategoryId])		
								VALUES ('ComprehensiveTargetedSupportSchTypeID','Targeted Support and Improvement – Exit Status', 0)
		SELECT @CategoryId = CategoryId FROM App.Categories Where CategoryCode = 'ComprehensiveTargetedSupportSchTypeID'
		...
		IF NOT EXISTS (SELECT 1 FROM [App].[Categories] WHERE [CategoryCode] = 'TargetedSupportIdentificationTypeID')
							INSERT INTO [App].[Categories] 
								([CategoryCode] ,[CategoryName], [EdFactsCategoryId])		
								VALUES ('TargetedSupportIdentificationTypeID','Additional targeted support and improvement school', 0)
		...
		IF NOT EXISTS (SELECT 1 FROM [App].[CategoryOptions] co WHERE co.CategoryId = @CategoryId AND CategoryOptionCode = 'TSIUNDER')
			BEGIN 
				INSERT INTO App.CategoryOptions (CategorySetId, CategoryId, CategoryOptionCode, CategoryOptionName, EdFactsCategoryCodeId) 
				VALUES (@CategorySetId, @CategoryId, 'TSIUNDER', 'Consistently underperforming subgroups school', 0)
			END 
		...
		IF NOT EXISTS (SELECT 1 FROM [App].[Categories] WHERE [CategoryCode] = 'TargetedSupportIdentificationTypeID')
							INSERT INTO [App].[Categories] 
								([CategoryCode] ,[CategoryName], [EdFactsCategoryId])		
								VALUES ('TargetedSupportIdentificationTypeID','Consistently underperforming subgroups school', 0)
		SELECT @CategoryId = CategoryId FROM App.Categories Where CategoryCode = 'TargetedSupportIdentificationTypeID'
		...
		IF NOT EXISTS (SELECT 1 FROM [App].[Categories] WHERE [CategoryCode] = 'TargetedSupportIdentificationTypeID')
							INSERT INTO [App].[Categories] 
								([CategoryCode] ,[CategoryName], [EdFactsCategoryId])		
								VALUES ('TargetedSupportIdentificationTypeID','Missing', 0)
		SELECT @CategoryId = CategoryId FROM App.Categories Where CategoryCode = 'TargetedSupportIdentificationTypeID'
