...
*/    
	...
	END
		...
		INSERT INTO [RDS].[DimK12StudentStatuses] -- Duane
           (
			  MobilityStatus12moCode
			, MobilityStatus12moDescription
			, MobilityStatus12moEdFactsCode
		...
		FROM (VALUES('QAD', 'QAD occurred within 12 months', 'QAD'),('MISSING', 'MISSING', 'MISSING')) ms12 (CedsOptionSetCode, CedsOptionSetDescription, EdFactsCode)
		CROSS JOIN (VALUES('QAD36', 'QAD occurred more than 36 months', 'QAD36'),('MISSING', 'MISSING', 'MISSING')) ms36 (CedsOptionSetCode, CedsOptionSetDescription, EdFactsCode)
		CROSS JOIN (VALUES('QMRSY', 'Any qualifying arrival date within a regular school year', 'QMRSY'),('MISSING', 'MISSING', 'MISSING')) mssy (CedsOptionSetCode, CedsOptionSetDescription, EdFactsCode)
		CROSS JOIN (VALUES('ReferralServices', 'Referral Services', 'REFER'),('MISSING', 'MISSING', 'MISSING')) rs (CedsOptionSetCode, CedsOptionSetDescription, EdFactsCode)
		LEFT JOIN rds.DimK12StudentStatuses main
			ON ms12.CedsOptionSetCode = main.MobilityStatus12moCode
			AND ms36.CedsOptionSetCode = main.MobilityStatus36moCode
			AND mssy.CedsOptionSetCode = main.MobilityStatusSYCode
			AND rs.CedsOptionSetCode = main.ReferralStatusCode
