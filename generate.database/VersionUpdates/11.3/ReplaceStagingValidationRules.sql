...
Version 11.3:
Fixed two rules that caused a failure when running for Discipline
...
,(N'ChildCount, Exiting, Discipline, Assessment', N'IDEAIndicator cannot be NULL', N'ProgramParticipationSpecialEducation', N'IDEAIndicator', N'Null Value', NULL, NULL, NULL, NULL, 'Warning', 'Generate')
...
,(N'ChildCount, Exiting, Discipline, Assessment, Membership', N'IDEA students must have an IDEA Start Date', N'ProgramParticipationSpecialEducation', N'IDEAIndicator', N'Bad Value', NULL, NULL, N'where isnull(IDEAIndicator,0) = 0 and ProgramParticipationBeginDate is null', N'Value is 0 or NULL but student has a PrimaryDisabilityType', 'Warning', 'Generate')
