...
*****************************/
	...
	insert into #firstAssessed(PersonId, DimSchoolId, DimLeaId, DimSeaId, DimCountDateId, FirstAssessedDate)
	SELECT reg.PersonId, org.DimSchoolId, org.DimLeaId, org.DimSeaId, org.DimCountDateId,  min(adm.StartDate) as 'FirstAssessedDate'
    ...
    group by reg.PersonId, org.DimSchoolId, org.DimLeaId, org.DimSeaId, org.DimCountDateId         
				
	insert into #progressLevel(PersonId, DimSchoolId, DimLeaId, DimSeaId, DimCountDateId, AcademicSubject, ProgressLevel)            
	SELECT distinct reg.PersonId, org.DimSchoolId, org.DimLeaId, org.DimSeaId, org.DimCountDateId, sub.Code as AcademicSubject, 
