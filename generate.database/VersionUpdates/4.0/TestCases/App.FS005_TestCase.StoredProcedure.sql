...
/* Test Case 3:
	...
	DROP INDEX Staging.K12Enrollment.ix_K12Enrollment_SIS_LIS_SchIS
	DROP INDEX Staging.Discipline.ix_Discipline_SIS_LIS_SchIS 
	DROP INDEX Staging.PersonStatus.ix_PersonStatus_SIS_LIS_SchIS 
	DROP INDEX Staging.ProgramParticipationSpecialEducation.ix_ProgramParticipationSpecialEducation_SIS_LIS_SchIS 
	DROP INDEX Staging.PersonRace.ix_PersonRace_SIS_LIS_SchIS 
	DROP INDEX Staging.PersonStatus.ix_PersonStatus_IDEAIndicator
END