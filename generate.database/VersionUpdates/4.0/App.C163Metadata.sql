...
declare @latestSubmissionYear as int, @lastSubmissionYear as int, @CategorySetCode as varchar(50), @GenerateReportId as int, @CategorySetId as int, @LevelId as int

set @latestSubmissionYear = 2020
set @lastSubmissionYear = 2019
