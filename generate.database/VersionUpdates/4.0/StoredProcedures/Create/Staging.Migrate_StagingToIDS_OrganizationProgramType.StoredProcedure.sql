USE [generate]
GO
/****** Object:  StoredProcedure [Staging].[Migrate_StagingToIDS_OrganizationProgramType]    Script Date: 12/20/2021 2:41:51 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER PROCEDURE [Staging].[Migrate_StagingToIDS_OrganizationProgramType]
...
BEGIN
	...
	BEGIN TRY
		...
		LEFT JOIN dbo.OrganizationRelationship ore
			ON 
			opt.ProgramOrganizationId = ore.OrganizationId
