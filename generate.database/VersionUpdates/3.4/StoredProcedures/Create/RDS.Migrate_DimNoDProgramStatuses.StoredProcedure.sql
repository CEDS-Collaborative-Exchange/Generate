...
BEGIN
	...
	left join ods.RefAcademicCareerAndTechnicalOutcomesInProgram inProgram on inProgram.RefAcademicCareerAndTechnicalOutcomesInProgramId = ppn.RefAcademicCareerAndTechnicalOutcomesInProgramId
