...
BEGIN
	...
	inner join ods.OrganizationDetail od on org.OrganizationId = od.OrganizationId
	inner join ods.RefOrganizationType ot on od.RefOrganizationTypeId = ot.RefOrganizationTypeId
		and ot.Code = 'K12School'
	inner join ods.OrganizationPersonRole r on d.PersonId = r.PersonId and r.OrganizationId = org.OrganizationId	
	...
	inner join ods.OrganizationDetail od on org.LeaOrganizationId = od.OrganizationId
	inner join ods.RefOrganizationType ot on od.RefOrganizationTypeId = ot.RefOrganizationTypeId
		and ot.Code = 'LEA'
	inner join ods.OrganizationPersonRole r on d.PersonId = r.PersonId and r.OrganizationId = org.LeaOrganizationId	
