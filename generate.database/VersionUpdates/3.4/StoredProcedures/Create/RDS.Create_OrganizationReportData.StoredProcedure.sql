		...
		BEGIN
			...
			begin
				...
				begin
					...
					begin
						INSERT INTO [RDS].[FactOrganizationCountReports]
							...
							,UpdatedOperationalStatus
							,[UpdatedOperationalStatusId])
						select @categorySetCode,sch.CharterSchoolAuthorizerIdPrimary, sch.CharterSchoolAuthorizerIdSecondary,
				...
				BEGIN
					...
					inner join rds.DimCharterSchoolApproverAgency approver on fact.DimCharterSchoolApproverAgencyId = approver.DimCharterSchoolApproverAgencyId 
					left join rds.DimCharterSchoolApproverAgency secondaryApprover 
					on fact.DimCharterSchoolSecondaryApproverAgencyId = secondaryApprover.DimCharterSchoolApproverAgencyId
					WHERE dates.SubmissionYear = @reportYear and schools.CharterSchoolIndicator=1 and approver.IsApproverAgency = 'Yes' 
				...
				begin
					...
					begin
						...
						from (select distinct 1 as OrganizationCount,
							lea.SeaName as OrganizationName , lea.StateANSICode, lea.StateName, lea.StateCode,
			...
			begin
				...
				begin
					...
					begin
							...
							sch.SchoolName as OrganizationName ,sch.SchoolNcesIdentifier,sch.SchoolStateIdentifier,
							sch.LeaStateIdentifier,sch.LeaNcesIdentifier,
							sch.OutOfStateIndicator,sch.PhysicalAddressCity , sch.PhysicalAddressPostalCode, 
							sch.PhysicalAddressState, sch.PhysicalAddressStreet,
							sch.ReconstitutedStatus,
							@reportCode, @reportLevel, @reportYear, schStatus.SharedTimeStatusEdFactsCode,
							sch.SchoolTypeEdFactsCode, sch.StateANSICode, 
							sch.StateCode, sch.StateName,
							titleIStatus.Title1SchoolStatusEdFactsCode,sch.Telephone, 0 as TotalIndicator,		
							schStatus.VirtualSchoolStatusEdFactsCode, sch.Website,
							ISNULL(UpdatedSch.UpdatedOperationalStatusEffectiveDate, '') as OperationalStatusEffectiveDate,
							 sch.PriorLeaStateIdentifier, sch.PriorSchoolStateIdentifier, 
							ISNULL(UpdatedSch.SchoolOperationalStatusEdFactsCode, '') as UpdatedOperationalStatusEdFactsCode,
							ISNULL(UpdatedSch.SchoolOperationalStatusEdFactsCode, '') as UpdatedOperationalStatusId
