...
BEGIN
	...
	on s.PersonId = org.PersonId and s.DimCountDateId = org.DimCountDateId and r.OrganizationId = IIF(org.OrganizationId > 0 , org.OrganizationId, org.LeaOrganizationId)
