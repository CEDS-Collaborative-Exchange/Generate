...
BEGIN
	...
	CREATE TABLE #K12Schools (
		...
		LEFT JOIN dbo.K12Lea k12lea ON lea.OrganizationId = k12lea.OrganizationId
		...
		LEFT JOIN dbo.OrganizationWebsite website ON o.OrganizationId = website.OrganizationId
			AND (@dataCollectionId IS NULL OR website.DataCollectionId = @dataCollectionId)	
		LEFT JOIN dbo.OrganizationTelephone phone ON o.OrganizationId = phone.OrganizationId
