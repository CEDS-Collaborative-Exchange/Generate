...
BEGIN
	...
	END
		...
		exec rds.Migrate_DimK12Demographics @studentDateQuery, @schoolQuery, 1, @dataCollectionId
...
--		ISNULL(demo.LepStatusCode, 'MISSING'),
	...
	inner join #demoQuery demo on s.DimK12StudentId = demo.DimK12StudentId and s.DimCountDateId = demo.DimDateId
	left outer join @schoolQuery sch on s.DimK12StudentId = sch.DimK12StudentId and s.DimCountDateId = sch.DimCountDateId 
	left outer join @raceQuery race on s.DimK12StudentId = race.DimK12StudentId and s.DimCountDateId = race.DimCountDateId
	left outer join @assessmentQuery assess on s.DimK12StudentId = assess.DimK12StudentId and s.DimCountDateId = assess.DimCountDateId
	left outer join @ideaQuery idea on s.DimK12StudentId = idea.DimK12StudentId and s.DimCountDateId = idea.DimCountDateId 
									and sch.DimK12SchoolId = idea.DimK12SchoolId and sch.DimLeaId = idea.DimLeaId and sch.DimSeaId = idea.DimSeaId
	left outer join @programStatusQuery programStatus on s.DimK12StudentId = programStatus.DimK12StudentId 
	...
	left outer join @titleIIIStatusQuery titleIII  on s.DimK12StudentId = titleIII.DimK12StudentId and s.DimCountDateId = titleIII.DimCountDateId 
									and sch.DimK12SchoolId = titleIII.DimK12SchoolId and sch.DimLeaId = titleIII.DimLeaId
									and sch.DimSeaId = titleIII.DimSeaId
	left outer join @AssessmentStatusQuery asq on  s.DimK12StudentId = asq.DimK12StudentId and s.DimCountDateId = asq.DimCountDateId 
									and sch.DimK12SchoolId = asq.DimK12SchoolId and sch.DimLeaId = asq.DimLeaId
									and sch.DimSeaId = asq.DimSeaId
	left outer join @studentStatusQuery studentStatus on s.DimK12StudentId = studentStatus.DimK12StudentId 
									and s.DimCountDateId = studentStatus.DimCountDateId 
									and sch.DimK12SchoolId = studentStatus.DimK12SchoolId and sch.DimLeaId = studentStatus.DimLeaId
									and sch.DimSeaId = studentStatus.DimSeaId
	left join @NoDProgramStatus noDProgramStatus  on s.DimK12StudentId = noDProgramStatus.DimK12StudentId 
									and s.DimCountDateId = noDProgramStatus.DimCountDateId 
									and sch.DimK12SchoolId = noDProgramStatus.DimK12SchoolId and sch.DimLeaId = noDProgramStatus.DimLeaId
									and sch.DimSeaId = noDProgramStatus.DimSeaId
	left outer join @cteStatusQuery cteStatus  on s.DimK12StudentId = cteStatus.DimK12StudentId and s.DimCountDateId = cteStatus.DimCountDateId 
										and sch.DimK12SchoolId = cteStatus.DimK12SchoolId and sch.DimLeaId = cteStatus.DimLeaId
										and sch.DimSeaId = cteStatus.DimSeaId
	left outer join @title1StatusQuery title1  on s.DimK12StudentId = title1.DimK12StudentId and s.DimCountDateId = title1.DimCountDateId 
											and sch.DimK12SchoolId = title1.DimK12SchoolId and sch.DimLeaId = title1.DimLeaId
											and sch.DimSeaId = title1.DimSeaId
	left outer join @enrollmentStatusQuery enrollmentStatus  on s.DimK12StudentId = enrollmentStatus.DimK12StudentId 
	...
	BEGIN
		...
		LEFT JOIN rds.DimTitleiiiStatuses title3	ON title3.TitleiiiLanguageInstructionCode = q.TitleIIILanguageInstructionCode		
