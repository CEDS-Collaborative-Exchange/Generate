...
CREATE PROCEDURE [RDS].[Migrate_DimDates_Directories]
	@dimDirectoryId as int,
	@id as int 	
AS
BEGIN
	...
	from rds.BridgeDirectoryDate bd
	cross join rds.DimDates d
	where d.DimDateId <> -1
	--and bd.DimDirectoryId <> -1 and
	and bd.DimDirectoryId =@dimDirectoryId
