...
begin try
	...
	begin
			...
			begin
                ...
                if exists (select 'c' from app.GenerateReports where ReportCode = 'studentcount' and IsLocked = 1)
                begin
				    -- Log history
                ...
                if exists (select 'c' from app.GenerateReports where ReportCode = 'studentsex' and IsLocked = 1)
                begin
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
                ...
                if exists (select 'c' from app.GenerateReports where ReportCode = 'studentdisability' and IsLocked = 1)
                begin
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
                ...
                if exists (select 'c' from app.GenerateReports where ReportCode = 'studentrace' and IsLocked = 1)
                begin
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
                ...
                if exists (select 'c' from app.GenerateReports where ReportCode = 'studentswdtitle1' and IsLocked = 1)
                begin
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
			...
			begin
                ...
                if exists (select 'c' from app.GenerateReports where ReportCode = 'c002' and IsLocked = 1)
                begin
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
                ...
                if exists (select 'c' from app.GenerateReports where ReportCode = 'c089' and IsLocked = 1)
                begin
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
                ...
                if exists (select 'c' from app.GenerateReports where ReportCode = 'yeartoyearenvironmentcount' and IsLocked = 1)
                begin
    			    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
                ...
                if exists (select 'c' from app.GenerateReports where ReportCode = 'yeartoyearchildcount' and IsLocked = 1)
                begin
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
                ...
                if exists (select 'c' from app.GenerateReports where ReportCode = 'yeartoyearremovalcount' and IsLocked = 1)
                begin
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
                ...
                if exists (select 'c' from app.GenerateReports where ReportCode = 'studentssummary' and IsLocked = 1)
                begin
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
			...
			begin
                ...
                if exists (select 'c' from app.GenerateReports where ReportCode = 'c009' and IsLocked = 1)
                begin
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
                ...
                if exists (select 'c' from app.GenerateReports where ReportCode = 'exitspecialeducation' and IsLocked = 1)
                begin
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
				...
				if exists (select 'c' from app.GenerateReports where ReportCode = 'yeartoyearexitcount' and IsLocked = 1)
                begin
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c082' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c083' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
			...
			if exists (select 'c' from app.GenerateReports where ReportCode = 'c154' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c155' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c156' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c158' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c169' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c132' and IsLocked = 1)
            begin			
			    -- Log history 
			...
			begin
				if exists (select 'c' from app.GenerateReports where ReportCode = 'c033' and IsLocked = 1)
                begin
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
				...
				if exists (select 'c' from app.GenerateReports where ReportCode = 'c052' and IsLocked = 1)
                begin
				    ---- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
			...
			begin
				if exists (select 'c' from app.GenerateReports where ReportCode = 'c032' and IsLocked = 1)
                begin
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
			...
			begin
				if exists (select 'c' from app.GenerateReports where ReportCode = 'c040' and IsLocked = 1)
                begin
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
                ...
                if exists (select 'c' from app.GenerateReports where ReportCode = 'c045' and IsLocked = 1)
                begin
					-- Log history
					insert into app.DataMigrationHistories
					(DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
               	...
               	if exists (select 'c' from app.GenerateReports where ReportCode = 'cohortgraduationrate' and IsLocked = 1)
                begin			
				    -- Log history
				    ---- Log history
			...
			begin
				if exists (select 'c' from app.GenerateReports where ReportCode = 'indicator9' and IsLocked = 1)
                begin
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
                ...
                if exists (select 'c' from app.GenerateReports where ReportCode = 'indicator10' and IsLocked = 1)
                begin
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
			...
			begin
				if exists (select 'c' from app.GenerateReports where ReportCode = 'c116' and IsLocked = 1)
                begin
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
				...
				if exists (select 'c' from app.GenerateReports where ReportCode = 'c141' and IsLocked = 1)
                begin
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
			...
			begin
				...
				if exists (select 'c' from app.GenerateReports where ReportCode = 'c204' and IsLocked = 1)
                begin			
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
			...
			begin
                ...
                if exists (select 'c' from app.GenerateReports where ReportCode = 'c037' and IsLocked = 1)
                begin
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
				...
				if exists (select 'c' from app.GenerateReports where ReportCode = 'c134' and IsLocked = 1)
                begin
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
			...
			if @factTypeCode = 'mep'
			begin
				 if exists (select 'c' from app.GenerateReports where ReportCode = 'c054' and IsLocked = 1)
                begin
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
                ...
                if exists (select 'c' from app.GenerateReports where ReportCode = 'c121' and IsLocked = 1)
                begin
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
                ...
                if exists (select 'c' from app.GenerateReports where ReportCode = 'c122' and IsLocked = 1)
                begin
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
				 ...
				 if exists (select 'c' from app.GenerateReports where ReportCode = 'c145' and IsLocked = 1)
                begin
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
			...
			begin
				if exists (select 'c' from app.GenerateReports where ReportCode = 'c165' and IsLocked = 1)
                begin
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
			...
			begin
                ...
                if exists (select 'c' from app.GenerateReports where ReportCode = 'c119' and IsLocked = 1)
                begin
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
				...
				if exists (select 'c' from app.GenerateReports where ReportCode = 'c127' and IsLocked = 1)
                begin
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
				...
				if exists (select 'c' from app.GenerateReports where ReportCode = 'c180' and IsLocked = 1)
                begin
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
                ...
                if exists (select 'c' from app.GenerateReports where ReportCode = 'c181' and IsLocked = 1)
                begin
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
			...
			begin
				...
				if exists (select 'c' from app.GenerateReports where ReportCode = 'c118' and IsLocked = 1)
                begin			
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
				...
				if exists (select 'c' from app.GenerateReports where ReportCode = 'c194' and IsLocked = 1)
                begin
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
			...
			begin
				 if exists (select 'c' from app.GenerateReports where ReportCode = 'c195' and IsLocked = 1)
                begin
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
			...
			begin
				 if exists (select 'c' from app.GenerateReports where ReportCode = 'c150' and IsLocked = 1)
                begin			
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
                ...
                if exists (select 'c' from app.GenerateReports where ReportCode = 'c151' and IsLocked = 1)
                begin			
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
			...
			begin
				if exists (select 'c' from app.GenerateReports where ReportCode = 'c160' and IsLocked = 1)
                begin			
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
			...
			begin
				  if exists (select 'c' from app.GenerateReports where ReportCode = 'studentfederalprogramsparticipation' and IsLocked = 1)
                begin			
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
                ...
                if exists (select 'c' from app.GenerateReports where ReportCode = 'studentmultifedprogsparticipation' and IsLocked = 1)
                begin			
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
                ...
                if exists (select 'c' from app.GenerateReports where ReportCode = 'edenvironmentdisabilitiesage3-5' and IsLocked = 1)
                begin			
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
                ...
                if exists (select 'c' from app.GenerateReports where ReportCode = 'edenvironmentdisabilitiesage6-21' and IsLocked = 1)
                begin			
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
	...
	begin
			if @factTypeCode = 'datapopulation' 
                ...
                if exists (select 'c' from app.GenerateReports where ReportCode = 'studentdiscipline' and IsLocked = 1)
                begin			
                    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
			...
			begin
                ...
                if exists (select 'c' from app.GenerateReports where ReportCode = 'c005' and IsLocked = 1)
                begin			
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
                ...
                if exists (select 'c' from app.GenerateReports where ReportCode = 'c006' and IsLocked = 1)
                begin			
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
                ...
                if exists (select 'c' from app.GenerateReports where ReportCode = 'c007' and IsLocked = 1)
                begin			
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
                ...
                if exists (select 'c' from app.GenerateReports where ReportCode = 'c086' and IsLocked = 1)
                begin			
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
                ...
                if exists (select 'c' from app.GenerateReports where ReportCode = 'c088' and IsLocked = 1)
                begin			
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
                ...
                if exists (select 'c' from app.GenerateReports where ReportCode = 'c143' and IsLocked = 1)
                begin			
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
                ...
                if exists (select 'c' from app.GenerateReports where ReportCode = 'c144' and IsLocked = 1)
                begin			
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
                ...
                if exists (select 'c' from app.GenerateReports where ReportCode = 'indicator4a' and IsLocked = 1)
                begin			
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
                ...
                if exists (select 'c' from app.GenerateReports where ReportCode = 'indicator4b' and IsLocked = 1)
                begin			
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
                ...
                if exists (select 'c' from app.GenerateReports where ReportCode = 'disciplinaryremovals' and IsLocked = 1)
                begin			
				    -- Log history
				    insert into app.DataMigrationHistories
				    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
	...
	begin
		...
		begin
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'studentsubpopulation' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
		...
		begin
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c113' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c125' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c126' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c139' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c175' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c178' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c179' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c185' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c188' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c189' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c138' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c137' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c050' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c142' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c157' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'stateassessmentsperformance' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
	...
	begin
		...
		begin
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c070' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c099' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c112' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c059' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c067' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c203' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
	...
	begin
		...
		begin
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c029' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c039' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c129' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c130' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c193' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c190' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c196' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c197' and IsLocked = 1)
            begin			
			    --	Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c198' and IsLocked = 1)
            begin			
			    --	Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c103' and IsLocked = 1)
            begin			
			    -- Log history
                insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c131' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c205' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c206' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c163' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c170' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c035' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
	...
	begin
		...
		begin
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c199' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c200' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c201' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
            ...
            if exists (select 'c' from app.GenerateReports where ReportCode = 'c202' and IsLocked = 1)
            begin			
			    -- Log history
			    insert into app.DataMigrationHistories
			    (DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) 
