...
BEGIN
	...
	left outer join rds.DimSchools sch on sch.SchoolOrganizationId = o.OrganizationId
	...
	left outer join rds.DimLeas lea on lea.LeaOrganizationId = leaDetail.OrganizationId
	left outer join rds.DimLeas lea1 on lea1.LeaOrganizationId = l.OrganizationId
