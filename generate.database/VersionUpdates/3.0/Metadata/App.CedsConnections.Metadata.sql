...
DECLARE UseCase_Cursor CURSOR FOR 
	SELECT UseCaseId, [Description], TitleQuestion, [Source] FROM [dat].dbo.UseCase 
		...
		(	
			...
			--CIID-1668
			197,	--Data Group 628: N or D academic achievement table - State Agency, c125
			199,	--Data Group 656: N or D participation table for State Agency, c119
			204,	--Data Group 629: N or D academic achievement table - LEA, c125
			207,	--Data Group 657: N or D participation table - LEA, c127
			218,	--Data Group 671: N or D long term table - LEA
			219,	--Data Group 672: N or D long term table - State Agency
			706,    --c113
			707,    --c119
			602,	--c119 and c127
			708,    --c125
...
begin try
	begin transaction
		...
		BEGIN
			...
			([CedsConnectionDescription],[CedsConnectionName],[CedsConnectionSource],[CedsUseCaseId])
			VALUES
			('Connection for Generate, EDFacts File FS037, created in collaboration with the EDFacts Partner Support Center (PSC) and the Center for the Integration of IDEA Data (CIID).','CSPR II Report | FS037: Title I Part A SWP/TAS Participation (Generate)','SLDS State Support Team',2959)
		END
		ELSE
		BEGIN
			update App.CedsConnections
		...
		BEGIN
			...
			([CedsConnectionDescription],[CedsConnectionName],[CedsConnectionSource],[CedsUseCaseId])
			VALUES
			('Connection for Generate, EDFacts File FS134, created in collaboration with the EDFacts Partner Support Center (PSC) and the Center for the Integration of IDEA Data (CIID).','CSPR II Report | FS134: Title I Part A Participation (Generate)','SLDS State Support Team',2960)
		END
		ELSE
		BEGIN
			update App.CedsConnections
		...
		BEGIN
			...
			([CedsConnectionDescription],[CedsConnectionName],[CedsConnectionSource],[CedsUseCaseId])
			VALUES
			('Connection for Generate, EDFacts File FS193, created in collaboration with the EDFacts Partner Support Center (PSC) and the Center for the Integration of IDEA Data (CIID).','CSPR II Report | FS193: Title I Allocations (Generate)','SLDS State Support Team',2971)
		END
		ELSE
		BEGIN
			update App.CedsConnections
		...
		BEGIN
			...
			([CedsConnectionDescription],[CedsConnectionName],[CedsConnectionSource],[CedsUseCaseId])
			VALUES
			('Connection for Generate, EDFacts File FS129, created in collaboration with the EDFacts Partner Support Center (PSC) and the Center for the Integration of IDEA Data (CIID).','CCD Report | FS129: CCD Schools (Generate)','SLDS State Support Team',2955)
		END
		ELSE
		BEGIN
			update App.CedsConnections
			set CedsConnectionDescription = 'Connection for Generate, EDFacts File FS129, created in collaboration with the EDFacts Partner Support Center (PSC) and the Center for the Integration of IDEA Data (CIID).', CedsConnectionName = 'CCD Report | FS129: CCD Schools (Generate)', CedsConnectionSource = 'SLDS State Support Team'
		...
		BEGIN
			...
			([CedsConnectionDescription],[CedsConnectionName],[CedsConnectionSource],[CedsUseCaseId])
			VALUES
			('Connection for Generate, EDFacts File FS059, created in collaboration with the EDFacts Partner Support Center (PSC) and CIID.','CCD Report | FS059: Staff FTE (Generate)','SLDS State Support Team',2958)
		END
		ELSE
		BEGIN
			update App.CedsConnections
			set CedsConnectionDescription = 'Connection for Generate, EDFacts File FS059, created in collaboration with the EDFacts Partner Support Center (PSC) and CIID.', CedsConnectionName = 'CCD Report | FS059: Staff FTE (Generate)', CedsConnectionSource = 'SLDS State Support Team'
		...
		BEGIN
			...
			([CedsConnectionDescription],[CedsConnectionName],[CedsConnectionSource],[CedsUseCaseId])
			VALUES
			('Connection for Generate, EDFacts File FS122, created in collaboration with the EDFacts Partner Support Center (PSC) and the Center for the Integration of IDEA Data (CIID).','CSPR II Report | FS122: MEP Students Eligible and Served – Summer/Intersession (Generate)','SLDS State Support Team',2987)
		END
		ELSE
		BEGIN
			update App.CedsConnections
		...
		BEGIN
			...
			([CedsConnectionDescription],[CedsConnectionName],[CedsConnectionSource],[CedsUseCaseId])
			VALUES
			('Connection for Generate, EDFacts File FS145, created in collaboration with the EDFacts Partner Support Center (PSC) and the Center for the Integration of IDEA Data (CIID).','CSPR II Report | FS145: MEP Services (Generate)','SLDS State Support Team',2988)
		END
		ELSE
		BEGIN
			update App.CedsConnections
		...
		BEGIN
			...
			([CedsConnectionDescription],[CedsConnectionName],[CedsConnectionSource],[CedsUseCaseId])
			VALUES
			('Connection for Generate, EDFacts File FS033, created in collaboration with the EDFacts Partner Support Center (PSC) and the Center for the Integration of IDEA Data (CIID).','CCD Report | FS033 Generate: Free and Reduced Price Lunch (Generate)','SLDS State Support Team',2964)
		END
		ELSE
		BEGIN
			update App.CedsConnections
		...
		BEGIN
			...
			([CedsConnectionDescription],[CedsConnectionName],[CedsConnectionSource],[CedsUseCaseId])
			VALUES
			('Connection for Generate, EDFacts File FS141, created in collaboration with the EDFacts Partner Support Center (PSC) and the Center for the Integration of IDEA Data (CIID).','CCD Report | FS141: LEP Enrolled (Generate)','SLDS State Support Team',2965)
		END
		ELSE
		BEGIN
			update App.CedsConnections
			set CedsConnectionDescription = 'Connection for Generate, EDFacts File FS141, created in collaboration with the EDFacts Partner Support Center (PSC) and the Center for the Integration of IDEA Data (CIID).', CedsConnectionName = 'CCD Report | FS141: LEP Enrolled (Generate)', CedsConnectionSource = 'SLDS State Support Team'
		...
		BEGIN
			...
			([CedsConnectionDescription],[CedsConnectionName],[CedsConnectionSource],[CedsUseCaseId])
			VALUES
			('Connection for Generate, EDFacts File FS054, created in collaboration with the EDFacts Partner Support Center (PSC) and the Center for the Integration of IDEA Data (CIID).','CSPR II Report | FS054: MEP Students Served - 12 Months (Generate)','SLDS State Support Team',2966)
		END
		ELSE
		BEGIN
			update App.CedsConnections
		...
		BEGIN
			...
			([CedsConnectionDescription],[CedsConnectionName],[CedsConnectionSource],[CedsUseCaseId])
			VALUES
			('Connection for Generate, EDFacts File FS121, created in collaboration with the EDFacts Partner Support Center (PSC) and the Center for the Integration of IDEA Data (CIID).','CSPR II Report | FS121: Migratory Students Eligible - 12 Months  (Generate)','SLDS State Support Team',2967)
		END
		ELSE
		BEGIN
			update App.CedsConnections
		...
		BEGIN
			...
			([CedsConnectionDescription],[CedsConnectionName],[CedsConnectionSource],[CedsUseCaseId])
			VALUES
			('Connection for Generate, EDFacts File FS165, created in collaboration with the EDFacts Partner Support Center (PSC) and the Center for the Integration of IDEA Data (CIID).','CSPR II Report | FS165: Migratory Data (Generate)','SLDS State Support Team',2968)
		END
		ELSE
		BEGIN
			update App.CedsConnections
		...
		BEGIN
			...
			([CedsConnectionDescription],[CedsConnectionName],[CedsConnectionSource],[CedsUseCaseId])
			VALUES
			('This Connection can be used as a template for new EDFacts reports in Generate.  The categories, data elements, analysis recommends, and related connections should be reviewed and updated to meet the needs of the EDFacts report.','FS086 — Students Involved with Firearms (Generate) SY2017-18','SLDS State Support Team',3132)
		END
		ELSE
		BEGIN
			update App.CedsConnections
			set CedsConnectionDescription = 'This Connection can be used as a template for new EDFacts reports in Generate.  The categories, data elements, analysis recommends, and related connections should be reviewed and updated to meet the needs of the EDFacts report.', CedsConnectionName = 'FS086 — Students Involved with Firearms (Generate) SY2017-18', CedsConnectionSource = 'SLDS State Support Team'
			where CedsUseCaseId = 3132
		END
 
		-----------------------------------------
		-- FS131 — LEA End of School Year Status (Generate) SY2017-18
		-----------------------------------------
		...
		BEGIN
			...
			([CedsConnectionDescription],[CedsConnectionName],[CedsConnectionSource],[CedsUseCaseId])
			VALUES
			('An indication that the local educational agency (LEA) notified the state of the LEA\"s intention to use REAP-Flex Alternative Uses of Funding Authority during the school year as specified in the Title V, Section 5211 of ESEA, as amended.','FS131 — LEA End of School Year Status (Generate) SY2017-18','SLDS State Support Team',3133)
		END
		ELSE
		BEGIN
			update App.CedsConnections
			set CedsConnectionDescription = 'An indication that the local educational agency (LEA) notified the state of the LEA\"s intention to use REAP-Flex Alternative Uses of Funding Authority during the school year as specified in the Title V, Section 5211 of ESEA, as amended.', CedsConnectionName = 'FS131 — LEA End of School Year Status (Generate) SY2017-18', CedsConnectionSource = 'SLDS State Support Team'
			where CedsUseCaseId = 3133
		END
 
		-----------------------------------------
		-- FS163 — Discipline Data (Generate) SY2017-18
		-----------------------------------------
		...
		BEGIN
			...
			([CedsConnectionDescription],[CedsConnectionName],[CedsConnectionSource],[CedsUseCaseId])
			VALUES
			('An indication of whether the school or local education agency (LEA) submitted a Gun-Free Schools Act (GFSA) of 1994 report to the state, as defined by Title 18, Section 921.','FS163 — Discipline Data (Generate) SY2017-18','SLDS State Support Team',3134)
		END
		ELSE
		BEGIN
			update App.CedsConnections
			set CedsConnectionDescription = 'An indication of whether the school or local education agency (LEA) submitted a Gun-Free Schools Act (GFSA) of 1994 report to the state, as defined by Title 18, Section 921.', CedsConnectionName = 'FS163 — Discipline Data (Generate) SY2017-18', CedsConnectionSource = 'SLDS State Support Team'
			where CedsUseCaseId = 3134
		END
 
		-----------------------------------------
		-- FS150 — Adjusted-Cohort Graduation Rate (Generate) SY2017-18
		-----------------------------------------
		...
		BEGIN
			...
			([CedsConnectionDescription],[CedsConnectionName],[CedsConnectionSource],[CedsUseCaseId])
			VALUES
			('Cohorts for four-year, five-year, and six-year adjusted-cohort graduation rate table.','FS150 — Adjusted-Cohort Graduation Rate (Generate) SY2017-18','SLDS State Support Team',3140)
		END
		ELSE
		BEGIN
			update App.CedsConnections
			set CedsConnectionDescription = 'Cohorts for four-year, five-year, and six-year adjusted-cohort graduation rate table.', CedsConnectionName = 'FS150 — Adjusted-Cohort Graduation Rate (Generate) SY2017-18', CedsConnectionSource = 'SLDS State Support Team'
			where CedsUseCaseId = 3140
		END
 
		-----------------------------------------
		-- FS160 — High School Graduates Postsecondary Enrollment (Generate) SY2017-18
		-----------------------------------------
		...
		BEGIN
			...
			([CedsConnectionDescription],[CedsConnectionName],[CedsConnectionSource],[CedsUseCaseId])
			VALUES
			('A school’s performance on the Graduation Rate Indicator.','FS199 — Graduation Rate Indicator Status','SLDS State Support Team',3142)
		END
		ELSE
		BEGIN
			update App.CedsConnections
			set CedsConnectionDescription = 'A school’s performance on the Graduation Rate Indicator.', CedsConnectionName = 'FS199 — Graduation Rate Indicator Status', CedsConnectionSource = 'SLDS State Support Team'
		...
		BEGIN
			...
			([CedsConnectionDescription],[CedsConnectionName],[CedsConnectionSource],[CedsUseCaseId])
			VALUES
			('Cohorts for four-year, five-year, and six-year adjusted-cohort graduation rate table.','FS151 — Cohorts for Adjusted-Cohort Graduation Rate','SLDS State Support Team',3146)
		END
		ELSE
		BEGIN
			update App.CedsConnections
			set CedsConnectionDescription = 'Cohorts for four-year, five-year, and six-year adjusted-cohort graduation rate table.', CedsConnectionName = 'FS151 — Cohorts for Adjusted-Cohort Graduation Rate', CedsConnectionSource = 'SLDS State Support Team'
		...
		BEGIN
			...
			([CedsConnectionDescription],[CedsConnectionName],[CedsConnectionSource],[CedsUseCaseId])
			VALUES
			('Connection for Generate, EDFacts File FS052, created in collaboration with the EDFacts Partner Support Center (PSC) and the Center for the Integration of IDEA Data (CIID).','CCD Report | FS052: Membership (Generate)','SLDS State Support Team',2984)
		END
		ELSE
		BEGIN
			update App.CedsConnections
			set CedsConnectionDescription = 'Connection for Generate, EDFacts File FS052, created in collaboration with the EDFacts Partner Support Center (PSC) and the Center for the Integration of IDEA Data (CIID).', CedsConnectionName = 'CCD Report | FS052: Membership (Generate)', CedsConnectionSource = 'SLDS State Support Team'
