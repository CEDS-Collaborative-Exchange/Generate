	...
	*************************************************************************************************************/
	BEGIN
		...
		BEGIN TRY
			...
			FROM Staging.PersonStatus ps
				JOIN ODS.RefPersonStatusType st 
		...
		BEGIN CATCH 
			EXEC App.Migrate_Data_Validation_Logging @eStoredProc, 'ODS.PersonStatus', NULL, 'S05EC390' 
		END CATCH
		...
		BEGIN CATCH 
			EXEC App.Migrate_Data_Validation_Logging @eStoredProc, 'Staging.PersonStatus', 'PersonStatusId_EnglishLearner', 'S05EC400' 
		END CATCH
