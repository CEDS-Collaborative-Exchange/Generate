...
BEGIN
	...
	--Populate the RDS tables from Staging data
		--Populate DimPeople
			...
			(DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) values	(getutcdate(), 2, 'RDS Graduates/Completers 1 of 6 - Staging-to-DimPeople_K12Students')
