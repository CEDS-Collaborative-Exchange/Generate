...
-- Drop temp tables.  This allows for running the procedure as a script while debugging
		...
		IF OBJECT_ID('tempdb.dbo.#vwDisciplineStatuses', 'U') IS NOT NULL DROP TABLE #vwDisciplineStatuses
	...
	-- Creating temp tables to be used in the select statement joins 
		...
		CREATE INDEX IX_vwDimDisciplines ON #vwDisciplineStatuses(SchoolYear, IdeaInterimRemovalMap, IdeaInterimRemovalReasonMap) 
			INCLUDE (IdeaInterimRemovalCode, IdeaInterimRemovalReasonCode)
