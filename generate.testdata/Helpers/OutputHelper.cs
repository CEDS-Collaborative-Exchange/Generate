...
namespace generate.testdata.Helpers
{
    public class OutputHelper : IOutputHelper
    {
        ...
        public StringBuilder AddRepopulationOfSourceSystemReferenceData(StringBuilder output, string testDataType, int schoolYear, bool isStartingSY)
        {
            ...
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefSpecialEducationStaffCategory', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'SpecialEducationStaffCategory'"));
