...
namespace generate.testdata.Helpers
{
    public class OutputHelper : IOutputHelper
    {
        ...
        public StringBuilder AddRepopulationOfSourceSystemReferenceData(StringBuilder output, string testDataType, int schoolYear, Boolean isStartingSY)
        {
            ...
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData VALUES (", schoolYear, ", 'RefNeglectedOrDelinquentProgramEnrollmentSubpart', NULL, '1', '1'), (", schoolYear, ", 'RefNeglectedOrDelinquentProgramEnrollmentSubpart', NULL, '2', '2')"));
        ...
        public StringBuilder UpdateCEDSValuesToNonCEDS(StringBuilder output)
        {
            ...
            output.AppendLine("Update Staging.OrganizationAddress set OrganizationType =  CASE WHEN OrganizationType IS NOT NULL THEN OrganizationType +  '_1' else OrganizationType END ");
