...
namespace generate.testdata.Helpers
{
    public class OutputHelper : IOutputHelper
    {
        ...
        public StringBuilder AddRepopulationOfSourceSystemReferenceData(StringBuilder output, string testDataType, int schoolYear, bool isStartingSY)
        {
            ...
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefK12StaffClassification', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'K12StaffClassification'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefParaprofessionalQualification', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'ParaprofessionalQualification'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefSpecialEducationStaffCategory', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'SpecialEducationSupportServicesCategory'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefSpecialEducationAgeGroupTaught', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'SpecialEducationAgeGroupTaught'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefTitleIProgramStaffCategory', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'TitleIProgramStaffCategory'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefCredentialType', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'CredentialType'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefHighSchoolDiplomaType', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'HighSchoolDiplomaType'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefAcademicSubject', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'AssessmentAcademicSubject'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefAssessmentPurpose', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'AssessmentPurpose'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefAssessmentType', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'AssessmentType'"));
            ...
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefGradeLevel', '000100', CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'EntryGradeLevel'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefGradeLevel', '000126', CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'GradeLevelWhenAssessed'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefGradeLevel', '000131', CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'GradesOffered'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefGradeLevel', '001210', CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'ExitGradeLevel'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefAssessmentReasonNotCompleting', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'AssessmentRegistrationReasonNotCompleting'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefAssessmentReasonNotTested', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'ReasonNotTested'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefFirearmType', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'FirearmType'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefDisciplineReason', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'DisciplineReason'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefDisciplinaryActionTaken', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'DisciplinaryActionTaken'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefIdeaInterimRemoval', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'IDEAInterimRemoval'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefIDEAInterimRemovalReason', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'IDEAInterimRemovalReason'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefDisciplineMethodOfCwd', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'DisciplineMethodOfChildrenWithDisabilities'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefDisciplineMethodFirearms', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'DisciplineMethodForFirearmsIncidents'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefIDEADisciplineMethodFirearm', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'IDEADisciplineMethodForFirearmsIncidents'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefIDEAEducationalEnvironmentEC', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'IDEAEducationalEnvironmentForEarlyChildhood'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefIDEAEducationalEnvironmentSchoolAge', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'IDEAEducationalEnvironmentForSchoolAge'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefSpecialEducationExitReason', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'SpecialEducationExitReason'"));
            ...
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefLanguage', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'ISO6393LanguageCode'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefMilitaryConnectedStudentIndicator', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'MilitaryConnectedStudentIndicator'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefDisabilityType', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'PrimaryDisabilityType'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefIdeaDisabilityType', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'IdeaDisabilityType'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefFoodServiceEligibility', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'EligibilityStatusForSchoolFoodServicePrograms'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefRace', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'Race'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefSex', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'Sex'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefOrganizationType', '001156', CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'OrganizationType'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefInstitutionTelephoneType', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'InstitutionTelephoneNumberType'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefOperationalStatus', '000174', CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'LEAOperationalStatus'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefOperationalStatus', '000533', CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'SchoolOperationalStatus'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefCharterSchoolAuthorizerType', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'CharterSchoolAuthorizerType'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefLeaType', NULL, CASE CedsOptionSetCode WHEN 'RegularNotInSupervisoryUnion' THEN '1' WHEN 'RegularInSupervisoryUnion' THEN '2' WHEN 'SupervisoryUnion' THEN '3' WHEN 'SpecializedPublicSchoolDistrict' THEN '9' WHEN 'ServiceAgency' THEN '4' WHEN 'StateOperatedAgency' THEN '5' WHEN 'FederalOperatedAgency' THEN '6' WHEN 'Other' THEN '8' WHEN 'IndependentCharterDistrict' THEN '7' END, CedsOptionSetCode FROM Ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'LocalEducationAgencyType'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT DISTINCT ", schoolYear, ", 'RefProgramType', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'ProgramType'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefK12LeaTitleISupportService', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'TitleISupportServices'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefTitleIInstructionalServices', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'TitleIInstructionalServices'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefTitleIProgramType', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'TitleIProgramType'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefMepProjectType', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'MigrantEducationProgramProjectType'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefSchoolType', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'SchoolType'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefOrganizationLocationType', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'AddressTypeForOrganization'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefState', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'StateAbbreviation'"));
            ...
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefFederalProgramFundingAllocationType', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'FederalProgramsFundingAllocationType'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefGunFreeSchoolsActReportingStatus', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'GunFreeSchoolsActReportingStatus'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefReconstitutedStatus', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'ReconstitutedStatus'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefProgressAchievingEnglishLanguageProficiencyIndicatorStatus', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'ProgressAchievingEnglishLanguageProficiencyIndicatorType'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefTitleISchoolStatus', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'TitleISchoolStatus'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefComprehensiveSupport', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'ComprehensiveSupportAndImprovementStatus'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefTargetedSupport', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'TargetedSupportAndImprovementStatus'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefSchoolDangerousStatus', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'PersistentlyDangerousStatus'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefMagnetSpecialProgram', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'MagnetOrSpecialProgramEmphasisSchool'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefVirtualSchoolStatus', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'VirtualSchoolStatus'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefNSLPStatus', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'NationalSchoolLunchProgramStatus'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefAssessmentTypeAdministered', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'AssessmentTypeAdministered'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData VALUES (", schoolYear, ", 'RefAssessmentTypeAdministered', NULL,'ADVASMTWACC','ADVASMTWACC')"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData VALUES (", schoolYear, ", 'RefAssessmentTypeAdministered', NULL,'ADVASMTWOACC','ADVASMTWOACC')"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData VALUES (", schoolYear, ", 'RefAssessmentTypeAdministered', NULL,'IADAPLASMTWACC','IADAPLASMTWACC')"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData VALUES (", schoolYear, ", 'RefAssessmentTypeAdministered', NULL,'IADAPLASMTWOACC','IADAPLASMTWOACC')"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData VALUES (", schoolYear, ", 'RefAssessmentTypeAdministered', NULL,'HSREGASMT2WACC','HSREGASMT2WACC')"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData VALUES (", schoolYear, ", 'RefAssessmentTypeAdministered', NULL,'HSREGASMT2WOACC','HSREGASMT2WOACC')"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData VALUES (", schoolYear, ", 'RefAssessmentTypeAdministered', NULL,'HSREGASMT3WACC','HSREGASMT3WACC')"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData VALUES (", schoolYear, ", 'RefAssessmentTypeAdministered', NULL,'HSREGASMT3WOACC','HSREGASMT3WOACC')"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData VALUES (", schoolYear, ", 'RefAssessmentTypeAdministered', NULL,'HSREGASMTIWACC','HSREGASMTIWACC')"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData VALUES (", schoolYear, ", 'RefAssessmentTypeAdministered', NULL,'HSREGASMTIWOACC','HSREGASMTIWOACC')"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData VALUES (", schoolYear, ", 'RefAssessmentTypeAdministered', NULL,'LSNRHSASMTWACC','LSNRHSASMTWACC')"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData VALUES (", schoolYear, ", 'RefAssessmentTypeAdministered', NULL,'LSNRHSASMTWOACC','LSNRHSASMTWOACC')"));


            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefAssessmentTypeAdministeredToEnglishLearners', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'AssessmentTypeAdministeredToEnglishLearners'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefNeglectedProgramType', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'NeglectedOrDelinquentProgramType'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefTitleIIndicator', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'TitleIIndicator'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefEnrollmentStatus', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'EnrollmentStatus'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefEntryType', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'EntryType'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefExitOrWithdrawalType', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'ExitOrWithdrawalType'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefPsEnrollmentStatus', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'PostsecondaryEnrollmentStatus'"));
            ...
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefUnexperiencedStatus', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'EDFactsTeacherInexperiencedStatus'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefOutOfFieldStatus', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'EDFactsTeacherOutOfFieldStatus'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefContinuationOfServices', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'ContinuationOfServicesReason'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefMepServiceType', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'MigrantEducationProgramServicesType'"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData SELECT ", schoolYear, ", 'RefMepEnrollmentType', NULL, CedsOptionSetCode, CedsOptionSetCode FROM ceds.CedsOptionSetMapping where CedsElementTechnicalName = 'MigrantEducationProgramEnrollmentType'"));
            ...
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData VALUES (", schoolYear, ",'RefCharterLeaStatus' ,NULL,'NA','NA')"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData VALUES (", schoolYear, ",'RefCharterLeaStatus' ,NULL,'NOTCHR','NOTCHR')"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData VALUES (", schoolYear, ",'RefCharterLeaStatus' ,NULL,'CHRTNOTLEA','CHRTNOTLEA')"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData VALUES (", schoolYear, ",'RefCharterLeaStatus' ,NULL,'CHRTIDEA','CHRTIDEA')"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData VALUES (", schoolYear, ",'RefCharterLeaStatus' ,NULL,'CHRTESEA','CHRTESEA')"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData VALUES (", schoolYear, ",'RefCharterLeaStatus' ,NULL,'CHRTIDEAESEA','CHRTIDEAESEA')"));

            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData VALUES (", schoolYear, ",'RefComprehensiveAndTargetedSupport' ,NULL,'CSI','CSI')"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData VALUES (", schoolYear, ",'RefComprehensiveAndTargetedSupport' ,NULL,'TSI','TSI')"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData VALUES (", schoolYear, ",'RefComprehensiveAndTargetedSupport' ,NULL,'CSIEXIT','CSIEXIT')"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData VALUES (", schoolYear, ",'RefComprehensiveAndTargetedSupport' ,NULL,'TSIEXIT','TSIEXIT')"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData VALUES (", schoolYear, ",'RefComprehensiveAndTargetedSupport' ,NULL,'NOTCSITSI','NOTCSITSI')"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData VALUES (", schoolYear, ",'RefComprehensiveAndTargetedSupport' ,NULL,'MISSING','MISSING')"));

            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData VALUES (", schoolYear, ",'RefSubgroup' ,NULL,'EconomicDisadvantage','EconomicDisadvantage')"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData VALUES (", schoolYear, ",'RefSubgroup' ,NULL,'IDEA','IDEA')"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData VALUES (", schoolYear, ",'RefSubgroup' ,NULL,'LEP','LEP')"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData VALUES (", schoolYear, ",'RefSubgroup' ,NULL,'AmericanIndianorAlaskaNative','AmericanIndianorAlaskaNative')"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData VALUES (", schoolYear, ",'RefSubgroup' ,NULL,'Asian','Asian')"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData VALUES (", schoolYear, ",'RefSubgroup' ,NULL,'AsianPacificIslander','AsianPacificIslander')"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData VALUES (", schoolYear, ",'RefSubgroup' ,NULL,'BlackorAfricanAmerican','BlackorAfricanAmerican')"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData VALUES (", schoolYear, ",'RefSubgroup' ,NULL,'Filipino','Filipino')"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData VALUES (", schoolYear, ",'RefSubgroup' ,NULL,'HispanicNotPurtoRican','HispanicNotPurtoRican')"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData VALUES (", schoolYear, ",'RefSubgroup' ,NULL,'HispanicLatino','HispanicLatino')"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData VALUES (", schoolYear, ",'RefSubgroup' ,NULL,'TwoorMoreRaces','TwoorMoreRaces')"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData VALUES (", schoolYear, ",'RefSubgroup' ,NULL,'NativeHawaiianorOtherPacificIslander','NativeHawaiianorOtherPacificIslander')"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData VALUES (", schoolYear, ",'RefSubgroup' ,NULL,'PuertoRican','PuertoRican')"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData VALUES (", schoolYear, ",'RefSubgroup' ,NULL,'White','White')"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData VALUES (", schoolYear, ",'RefSubgroup' ,NULL,'UnderservedRaceEthnicity','UnderservedRaceEthnicity')"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData VALUES (", schoolYear, ",'RefComprehensiveSupportReasonApplicability' ,NULL,'ReasonApplies','ReasonApplies')"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData VALUES (", schoolYear, ",'RefComprehensiveSupportReasonApplicability' ,NULL,'ReasonDoesNotApply','ReasonDoesNotApply')"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData VALUES (", schoolYear, ",'RefEmergencyOrProvisionalCredentialStatus' ,NULL,'TCHWEMRPRVCRD','TCHWEMRPRVCRD')"));
            output.AppendLine(string.Concat("INSERT INTO Staging.SourceSystemReferenceData VALUES (", schoolYear, ",'RefEmergencyOrProvisionalCredentialStatus' ,NULL,'TCHWOEMRPRVCRD','TCHWOEMRPRVCRD')"));
