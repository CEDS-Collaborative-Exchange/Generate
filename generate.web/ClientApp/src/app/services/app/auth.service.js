...
var AuthService = function () {
    ...
    var AuthService = _classThis = /** @class */ (function () {
        function AuthService_1(_userService, appConfig) {
            var _this = this;
            ...
            this.appConfig.getConfig().subscribe(function (res) {
                ...
                _this.app = new msal_browser_1.PublicClientApplication(msalConfig);
                _this.initializeMsal();
            });
        }
        AuthService_1.prototype.initializeMsal = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 3, , 4]);
                            return [4 /*yield*/, this.app.initialize()];
                        case 1:
                            _a.sent();
                            return [4 /*yield*/, this.app.handleRedirectPromise()];
                        case 2:
                            _a.sent();
                        ...
                        case 3:
                            error_1 = _a.sent();
                            console.error('MSAL initialization error:', error_1);
                            return [3 /*break*/, 4];
        ...
        AuthService_1.prototype.login = function () {
            return __awaiter(this, void 0, void 0, function () {
                var loginResponse, data, error_2;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!!this.isMsalInitialized) return [3 /*break*/, 2];
                            return [4 /*yield*/, this.initializeMsal()];
                        case 1:
                            _a.sent();
                            _a.label = 2;
                        case 2:
                            _a.trys.push([2, 4, , 5]);
                            return [4 /*yield*/, this.app.loginPopup({
                        ...
                        case 4:
                            error_2 = _a.sent();
                            if (error_2 instanceof msal_browser_1.AuthError) {
                                console.error('Authentication error:', error_2.errorMessage);
                            }
                            else {
                                console.error('Unexpected error during login:', error_2);
                            }
                            return [3 /*break*/, 5];
