...
exports.SettingsRoutingModule = void 0;
...
var featureRoutes = [
    {
        ...
        children: [
            { path: 'toggle', component: toggle_component_1.SettingsToggleComponent, canDeactivate: [confirmation_guard_1.ConfirmationGuard] },
            { path: 'toggle/assessment', component: toggle_assessment_component_1.SettingsToggleAssessmentComponent },
            { path: 'metadata', component: metadata_component_1.MetadataComponent },
            { path: 'datamigration', component: reportmigration_component_1.ReportMigationComponent },
            { path: 'datamigration/reportmigration', component: reportmigration_component_1.ReportMigationComponent },
