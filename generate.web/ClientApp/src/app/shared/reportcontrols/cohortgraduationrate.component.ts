...
export class CohortGradRateComponent implements AfterViewInit, OnChanges, OnInit {
    ...
    itemsSourceChanged(s, e) {
        ...
        if (this.reportParameters.reportCategorySetCode === 'exitingspeceducation') {
            s.columnHeaders.rows.defaultSize = 180;
        }
    ...
    getGraphHeader() {
        ...
        if (this.reportParameters.reportCategorySet !== undefined) {
            if (filterText.length > 0) {
                filterText = filterText + ', ' + this.reportParameters.reportCategorySet.categorySetName;
            } else {
                filterText = filterText + this.reportParameters.reportCategorySet.categorySetName;
            }
        }
    ...
    getXAxisTitle() {
        let categoryString: string = this.reportParameters.reportCategorySet.categorySetName + ' - ';
        ...
        if (this.reportParameters.reportCategorySet.categories.length > 0) {
            for (let i = 0; i < this.reportParameters.reportCategorySet.categories.length; ++i) {
                ...
                categoryString += this.reportParameters.reportCategorySet.categories[i];
            }
        }
