...
@Component({
    selector: 'generate-app-c197',
    templateUrl: './c197.component.html',
    styleUrls: ['./c197.component.scss'],
    providers: [GenerateReportService]
})

export class C197Component implements AfterViewInit, OnChanges, OnInit {
