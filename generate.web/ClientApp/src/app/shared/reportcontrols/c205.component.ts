...
@Component({
    selector: 'generate-app-205',
    templateUrl: './c205.component.html',
    styleUrls: ['./c205.component.scss'],
    providers: [GenerateReportService]
})

export class C205Component implements AfterViewInit, OnChanges, OnInit {
