...
@Component({
    ...
    styleUrls: ['./c163.component.scss'],
    templateUrl: './c163.component.html',
    providers: [GenerateReportService]
})

export class C163Component implements AfterViewInit, OnChanges, OnInit {
    ...
    export() {
        ...
        let caption = "Gun-Free Schools Act (GFSA) report submitted to the state";
        ...
        this.flextableComponent.exportToExcel(fileName, reportTitle, caption, totalCaption, reportCols, reportRows, reportCaptionCol);
