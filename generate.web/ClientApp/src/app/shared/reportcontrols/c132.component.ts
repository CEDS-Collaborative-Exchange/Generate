...
@Component({
    selector: 'generate-app-c132',
    templateUrl: './c132.component.html',
    styleUrls: ['./c132.component.scss'],
    providers: [GenerateReportService]
})

export class C132Component implements AfterViewInit, OnChanges, OnInit {
    ...
    getReportYear() {
        if (this.reportDataDto.reportYear === '2017-18' || this.reportDataDto.reportYear === '2015-16' || this.reportDataDto.reportYear === '2014-15' || this.reportDataDto.reportYear === '2013-14')
            return true
        else
            return false;
    }
    ...
    export() {
        ...
        let yearCaption = this.reportParameters.reportYear;
        ...
        this.flextableComponent.exportToExcel(fileName, reportTitle, yearCaption, totalCaption, reportCols, reportRows, reportCaptionCol);
    ...
    getFileSubmission(dlg: any) {
      ...
      //  let submissionFile: GenerateReportDto = this.generateFiles.filter(file => { return file.reportCode === reportCode; })[0];
