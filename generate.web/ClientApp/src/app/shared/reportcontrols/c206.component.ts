...
@Component({
    selector: 'generate-app-206',
    templateUrl: './c206.component.html',
    styleUrls: ['./c206.component.scss'],
    providers: [GenerateReportService]
})

export class C206Component implements AfterViewInit, OnChanges, OnInit {
    ...
    getReportYear() {
        let isCurrentYear: boolean = false;
        if (this.reportDataDto !== undefined) {
            if (this.reportDataDto.reportYear === '2018-19')
                isCurrentYear = true;
            else
                isCurrentYear = false;
        }
    ...
    getReport201920Year() {
        let isCurrentYear: boolean = false;
        if (this.reportDataDto !== undefined) {
            if (this.reportDataDto.reportYear === '2019-20')
                isCurrentYear = true;
            else
                isCurrentYear = false;
        }
