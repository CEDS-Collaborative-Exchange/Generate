...
FROM    RDS.DimAeProgramParticipantAssessmentIndicators AS rdds CROSS JOIN
            ...
            Staging.SourceSystemReferenceData AS sssrd1 ON rdds.AeFunctioningLevelAtIntakeCode = sssrd1.OutputCode AND sssrd1.TableFilter = '000779' AND rsy.SchoolYear = sssrd1.SchoolYear LEFT OUTER JOIN
            Staging.SourceSystemReferenceData AS sssrd2 ON rdds.AeFunctioningLevelAtPosttestCode = sssrd2.OutputCode AND sssrd2.TableFilter = '000780' AND rsy.SchoolYear = sssrd2.SchoolYear
