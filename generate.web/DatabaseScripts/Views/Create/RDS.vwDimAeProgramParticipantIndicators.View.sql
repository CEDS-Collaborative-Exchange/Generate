...
FROM    RDS.DimAeProgramParticipantIndicators AS rdds CROSS JOIN
            ...
            Staging.SourceSystemReferenceData AS sssrd1 ON rdds.CorrectionalEducationReentryServicesParticipationIndicatorCode = sssrd1.OutputCode AND sssrd1.TableFilter = '001297' AND rsy.SchoolYear = sssrd1.SchoolYear