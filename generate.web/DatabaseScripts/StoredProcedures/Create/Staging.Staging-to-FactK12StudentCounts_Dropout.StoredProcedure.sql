		...
		BEGIN
			SELECT
				...
				, CASE
					...
					WHEN ISNULL(ske.ExitOrWithdrawalType, '') <> ISNULL(@ExitOrWithdrawalTypeMap, '') THEN 'WHERE ExitOrWithdrawalType'
				...
				, CASE WHEN ISNULL(ske.ExitOrWithdrawalType, '') = ISNULL(@ExitOrWithdrawalTypeMap, '') THEN 1 ELSE 0 END AS PassedExitOrWithdrawalTypeFilter
