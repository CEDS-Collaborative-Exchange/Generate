...
BEGIN
	...
	--Populate the RDS tables from ODS data
		--Populate DimPeople and DimPeople_Current
			...
			(DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) values	(getutcdate(), 2, 'RDS Exiting 1 of 6 - Staging-to-DimPeople_K12Students and DimPeople_Current')
