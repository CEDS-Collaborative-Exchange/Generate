...
BEGIN
	...
	--Populate the RDS tables from Staging data
		--Populate DimPeople and DimPeople_Current
			...
			(DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) values	(getutcdate(), 2, 'RDS Graduation Rate 1 of 6 - Staging-to-DimPeople_K12Students and DimPeople_Current')
		...
		--clear the data from the fact table
			...
			exec [rds].[Empty_RDS] 'graduationrate'
