...
begin try
	...
	begin transaction
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'SEA CHILDREN WITH DISABILITIES' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 1 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('SEA CHILDREN WITH DISABILITIES', @GenerateReportId, 1, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'SEA CHILDREN WITH DISABILITIES' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 1 and SubmissionYear = '2018-19'
		END
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'LEA CHILDREN WITH DISABILITIES' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 2 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('LEA CHILDREN WITH DISABILITIES', @GenerateReportId, 2, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'LEA CHILDREN WITH DISABILITIES' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 2 and SubmissionYear = '2018-19'
		END
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'SCHOOL CHILDREN WITH DISABILITIES' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 3 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('SCHOOL CHILDREN WITH DISABILITIES', @GenerateReportId, 3, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'SCHOOL CHILDREN WITH DISABILITIES' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 3 and SubmissionYear = '2018-19'
		END
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'SEA DIRECTORY INFO' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 1 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('SEA DIRECTORY INFO', @GenerateReportId, 1, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'SEA DIRECTORY INFO' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 1 and SubmissionYear = '2018-19'
		END
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'SCHOOL DIRECTORY INFO' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 3 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('SCHOOL DIRECTORY INFO', @GenerateReportId, 3, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'SCHOOL DIRECTORY INFO' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 3 and SubmissionYear = '2018-19'
		END
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'LEA DIRECTORY INFO' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 2 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('LEA DIRECTORY INFO', @GenerateReportId, 2, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'LEA DIRECTORY INFO' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 2 and SubmissionYear = '2018-19'
		END
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'SCHOOL FREE AND REDUCED PRICE LUNCH' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 3 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('SCHOOL FREE AND REDUCED PRICE LUNCH', @GenerateReportId, 3, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'SCHOOL FREE AND REDUCED PRICE LUNCH' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 3 and SubmissionYear = '2018-19'
		END
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'LEA FEDERAL PROGRAMS' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 2 and SubmissionYear = '2016-17')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('LEA FEDERAL PROGRAMS', @GenerateReportId, 2, '2016-17')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'LEA FEDERAL PROGRAMS' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 2 and SubmissionYear = '2016-17'
		END
...
')
		...
		([FileSubmissionId], [FileColumnId], [EndPosition], [IsOptional], [SequenceNumber], [StartPosition])
		VALUES
		(@fileSubmissionId, @fileColumnId, 303, 'false', 10, 104)
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'SEA FEDERAL PROGRAMS' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 1 and SubmissionYear = '2016-17')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('SEA FEDERAL PROGRAMS', @GenerateReportId, 1, '2016-17')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'SEA FEDERAL PROGRAMS' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 1 and SubmissionYear = '2016-17'
		END
...
')
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'LEA GRADES OFFERED' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 2 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('LEA GRADES OFFERED', @GenerateReportId, 2, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'LEA GRADES OFFERED' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 2 and SubmissionYear = '2018-19'
		END
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'SCHOOL GRADES OFFERED' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 3 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('SCHOOL GRADES OFFERED', @GenerateReportId, 3, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'SCHOOL GRADES OFFERED' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 3 and SubmissionYear = '2018-19'
		END
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'SEA MEMBERSHIP TABLE' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 1 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('SEA MEMBERSHIP TABLE', @GenerateReportId, 1, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'SEA MEMBERSHIP TABLE' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 1 and SubmissionYear = '2018-19'
		END
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'LEA MEMBERSHIP TABLE' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 2 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('LEA MEMBERSHIP TABLE', @GenerateReportId, 2, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'LEA MEMBERSHIP TABLE' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 2 and SubmissionYear = '2018-19'
		END
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'SCHOOL MEMBERSHIP TABLE' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 3 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('SCHOOL MEMBERSHIP TABLE', @GenerateReportId, 3, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'SCHOOL MEMBERSHIP TABLE' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 3 and SubmissionYear = '2018-19'
		END
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'SEA STAFF FTE' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 1 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('SEA STAFF FTE', @GenerateReportId, 1, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'SEA STAFF FTE' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 1 and SubmissionYear = '2018-19'
		END
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'LEA STAFF FTE' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 2 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('LEA STAFF FTE', @GenerateReportId, 2, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'LEA STAFF FTE' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 2 and SubmissionYear = '2018-19'
		END
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'SCHOOL STAFF FTE' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 3 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('SCHOOL STAFF FTE', @GenerateReportId, 3, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'SCHOOL STAFF FTE' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 3 and SubmissionYear = '2018-19'
		END
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'SEA CHILDREN WITH DISABILITIES (IDEA) EC ' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 1 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('SEA CHILDREN WITH DISABILITIES (IDEA) EC ', @GenerateReportId, 1, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'SEA CHILDREN WITH DISABILITIES (IDEA) EC ' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 1 and SubmissionYear = '2018-19'
		END
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'LEA CHILDREN WITH DISABILITIES (IDEA) EC ' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 2 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('LEA CHILDREN WITH DISABILITIES (IDEA) EC ', @GenerateReportId, 2, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'LEA CHILDREN WITH DISABILITIES (IDEA) EC ' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 2 and SubmissionYear = '2018-19'
		END
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'CCD SCHOOL' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 3 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('CCD SCHOOL', @GenerateReportId, 3, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'CCD SCHOOL' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 3 and SubmissionYear = '2018-19'
		END
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'SCHOOL NCLB SY START STATUS' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 3 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('SCHOOL NCLB SY START STATUS', @GenerateReportId, 3, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'SCHOOL NCLB SY START STATUS' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 3 and SubmissionYear = '2018-19'
		END
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'SEA LEP ENROLLED' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 1 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('SEA LEP ENROLLED', @GenerateReportId, 1, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'SEA LEP ENROLLED' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 1 and SubmissionYear = '2018-19'
		END
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'LEA LEP ENROLLED' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 2 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('LEA LEP ENROLLED', @GenerateReportId, 2, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'LEA LEP ENROLLED' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 2 and SubmissionYear = '2018-19'
		END
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'SCHOOL LEP ENROLLED' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 3 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('SCHOOL LEP ENROLLED', @GenerateReportId, 3, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'SCHOOL LEP ENROLLED' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 3 and SubmissionYear = '2018-19'
		END
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'SCHOOL HS GRAD POSTSECONDARY ENROLLMENT' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 3 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('SCHOOL HS GRAD POSTSECONDARY ENROLLMENT', @GenerateReportId, 3, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'SCHOOL HS GRAD POSTSECONDARY ENROLLMENT' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 3 and SubmissionYear = '2018-19'
		END
		...
		([FileSubmissionId], [FileColumnId], [EndPosition], [IsOptional], [SequenceNumber], [StartPosition])
		VALUES
		(@fileSubmissionId, @fileColumnId, 369, 'false', 15, 360)
		...
		([FileSubmissionId], [FileColumnId], [EndPosition], [IsOptional], [SequenceNumber], [StartPosition])
		VALUES
		(@fileSubmissionId, @fileColumnId, 370, 'false', 16, 370)
		...
		([FileSubmissionId], [FileColumnId], [EndPosition], [IsOptional], [SequenceNumber], [StartPosition])
		VALUES
		(@fileSubmissionId, @fileColumnId, 359, 'true', 14, 160)
		...
		([ColumnLength], [ColumnName], [DataType], [DisplayName], [XMLElementName])
		VALUES
		(15, 'PSEnrollActionID','String', 'Postsecondary Enrollment Action', 'CATEGORY')
		...
		([ColumnLength], [ColumnName], [DataType], [DisplayName], [XMLElementName])
		VALUES
		(15, 'RaceEthnicityID','String', 'Major Racialand Ethnic Groups', 'CATEGORY')
		...
		([FileSubmissionId], [FileColumnId], [EndPosition], [IsOptional], [SequenceNumber], [StartPosition])
		VALUES
		(@fileSubmissionId, @fileColumnId, 159, 'false', 13, 159)
 
 
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'LEA HS GRAD POSTSECONDARY ENROLLMENT' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 2 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('LEA HS GRAD POSTSECONDARY ENROLLMENT', @GenerateReportId, 2, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'LEA HS GRAD POSTSECONDARY ENROLLMENT' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 2 and SubmissionYear = '2018-19'
		END
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'SEA HS GRAD POSTSECONDARY ENROLLMENT' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 1 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('SEA HS GRAD POSTSECONDARY ENROLLMENT', @GenerateReportId, 1, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'SEA HS GRAD POSTSECONDARY ENROLLMENT' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 1 and SubmissionYear = '2018-19'
		END
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'SEA STUDENT PERFORMANCE MATH' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 1 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('SEA STUDENT PERFORMANCE MATH', @GenerateReportId, 1, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'SEA STUDENT PERFORMANCE MATH' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 1 and SubmissionYear = '2018-19'
		END
		...
		([ColumnLength], [ColumnName], [DataType], [DisplayName], [XMLElementName])
		VALUES
		(15, 'PerformanceLevelID','String', 'Peformance Level', 'CATEGORY')
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'LEA STUDENT PERFORMANCE MATH' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 2 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('LEA STUDENT PERFORMANCE MATH', @GenerateReportId, 2, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'LEA STUDENT PERFORMANCE MATH' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 2 and SubmissionYear = '2018-19'
		END
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'SCHOOL STUDENT PERFORMANCE MATH' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 3 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('SCHOOL STUDENT PERFORMANCE MATH', @GenerateReportId, 3, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'SCHOOL STUDENT PERFORMANCE MATH' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 3 and SubmissionYear = '2018-19'
		END
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'SEA STUDENT PERFORMANCE READING LANGUAGE ARTS' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 1 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('SEA STUDENT PERFORMANCE READING LANGUAGE ARTS', @GenerateReportId, 1, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'SEA STUDENT PERFORMANCE READING LANGUAGE ARTS' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 1 and SubmissionYear = '2018-19'
		END
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'LEA STUDENT PERFORMANCE READING LANGUAGE ARTS' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 2 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('LEA STUDENT PERFORMANCE READING LANGUAGE ARTS', @GenerateReportId, 2, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'LEA STUDENT PERFORMANCE READING LANGUAGE ARTS' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 2 and SubmissionYear = '2018-19'
		END
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'SCHOOL STUDENT PERFORMANCE READING LANGUAGE ARTS' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 3 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('SCHOOL STUDENT PERFORMANCE READING LANGUAGE ARTS', @GenerateReportId, 3, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'SCHOOL STUDENT PERFORMANCE READING LANGUAGE ARTS' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 3 and SubmissionYear = '2018-19'
		END
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'SEA STUDENT PERFORMANCE SCIENCE' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 1 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('SEA STUDENT PERFORMANCE SCIENCE', @GenerateReportId, 1, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'SEA STUDENT PERFORMANCE SCIENCE' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 1 and SubmissionYear = '2018-19'
		END
		...
		([ColumnLength], [ColumnName], [DataType], [DisplayName], [XMLElementName])
		VALUES
		(15, 'PerformanceLevelID','String', 'Performance Level', 'CATEGORY')
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'LEA STUDENT PERFORMANCE SCIENCE' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 2 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('LEA STUDENT PERFORMANCE SCIENCE', @GenerateReportId, 2, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'LEA STUDENT PERFORMANCE SCIENCE' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 2 and SubmissionYear = '2018-19'
		END
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'SCHOOL STUDENT PERFORMANCE SCIENCE' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 3 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('SCHOOL STUDENT PERFORMANCE SCIENCE', @GenerateReportId, 3, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'SCHOOL STUDENT PERFORMANCE SCIENCE' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 3 and SubmissionYear = '2018-19'
		END
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'SEA MATH ASSESSMENT PARTICIPATION' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 1 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('SEA MATH ASSESSMENT PARTICIPATION', @GenerateReportId, 1, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'SEA MATH ASSESSMENT PARTICIPATION' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 1 and SubmissionYear = '2018-19'
		END
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'LEA MATH ASSESSMENT PARTICIPATION' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 2 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('LEA MATH ASSESSMENT PARTICIPATION', @GenerateReportId, 2, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'LEA MATH ASSESSMENT PARTICIPATION' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 2 and SubmissionYear = '2018-19'
		END
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'SCHOOL MATH ASSESSMENT PARTICIPATION' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 3 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('SCHOOL MATH ASSESSMENT PARTICIPATION', @GenerateReportId, 3, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'SCHOOL MATH ASSESSMENT PARTICIPATION' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 3 and SubmissionYear = '2018-19'
		END
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'SEA RLA ASSESSMENT PARTICIPATION' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 1 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('SEA RLA ASSESSMENT PARTICIPATION', @GenerateReportId, 1, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'SEA RLA ASSESSMENT PARTICIPATION' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 1 and SubmissionYear = '2018-19'
		END
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'LEA RLA ASSESSMENT PARTICIPATION' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 2 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('LEA RLA ASSESSMENT PARTICIPATION', @GenerateReportId, 2, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'LEA RLA ASSESSMENT PARTICIPATION' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 2 and SubmissionYear = '2018-19'
		END
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'SCHOOL RLA ASSESSMENT PARTICIPATION' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 3 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('SCHOOL RLA ASSESSMENT PARTICIPATION', @GenerateReportId, 3, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'SCHOOL RLA ASSESSMENT PARTICIPATION' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 3 and SubmissionYear = '2018-19'
		END
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'SEA SCIENCE ASSESSMENT PARTICIPATION' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 1 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('SEA SCIENCE ASSESSMENT PARTICIPATION', @GenerateReportId, 1, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'SEA SCIENCE ASSESSMENT PARTICIPATION' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 1 and SubmissionYear = '2018-19'
		END
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'LEA SCIENCE ASSESSMENT PARTICIPATION' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 2 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('LEA SCIENCE ASSESSMENT PARTICIPATION', @GenerateReportId, 2, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'LEA SCIENCE ASSESSMENT PARTICIPATION' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 2 and SubmissionYear = '2018-19'
		END
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'SCHOOL SCIENCE ASSESSMENT PARTICIPATION' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 3 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('SCHOOL SCIENCE ASSESSMENT PARTICIPATION', @GenerateReportId, 3, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'SCHOOL SCIENCE ASSESSMENT PARTICIPATION' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 3 and SubmissionYear = '2018-19'
		END
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'SEA CHARTER AUTHORIZER' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 1112 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('SEA CHARTER AUTHORIZER', @GenerateReportId, 1112, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'SEA CHARTER AUTHORIZER' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 1112 and SubmissionYear = '2018-19'
		END
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'CHARTER MANAGE ORG' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 1182 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('CHARTER MANAGE ORG', @GenerateReportId, 1182, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'CHARTER MANAGE ORG' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 1182 and SubmissionYear = '2018-19'
		END
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'SCH CHAR ORG CROSSWALK' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 3 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('SCH CHAR ORG CROSSWALK', @GenerateReportId, 3, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'SCH CHAR ORG CROSSWALK' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 3 and SubmissionYear = '2018-19'
		END
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'SCH CHAR CONTRACTS' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 3 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('SCH CHAR CONTRACTS', @GenerateReportId, 3, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'SCH CHAR CONTRACTS' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 3 and SubmissionYear = '2018-19'
		END
		...
		If not exists (Select 1 from App.FileSubmissions where FileSubmissionDescription = 'SCH CSI TSI' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 3 and SubmissionYear = '2018-19')
		BEGIN
			INSERT INTO App.FileSubmissions
			([FileSubmissionDescription], [GenerateReportId], [OrganizationLevelId], [SubmissionYear])
			values
			('SCH CSI TSI', @GenerateReportId, 3, '2018-19')
		...
		ELSE
		BEGIN
			SELECT @fileSubmissionId = FileSubmissionId from App.FileSubmissions where FileSubmissionDescription = 'SCH CSI TSI' and GenerateReportId = @GenerateReportId and OrganizationLevelId = 3 and SubmissionYear = '2018-19'
		END
		...
		([ColumnLength], [ColumnName], [DataType], [DisplayName], [XMLElementName])
		VALUES
		(15, 'ComprehensiveSupportIdentificationTypeID','String', 'Comprehensive support identification', 'COMPSUPIDFNTYP')
		...
		([FileSubmissionId], [FileColumnId], [EndPosition], [IsOptional], [SequenceNumber], [StartPosition])
		VALUES
		(@fileSubmissionId, @fileColumnId, 78, 'true', 7, 64)
 
		INSERT INTO App.FileColumns
		([ColumnLength], [ColumnName], [DataType], [DisplayName], [XMLElementName])
		VALUES
		(15, 'ComprehensiveTargetedSupportSchTypeID','String', 'Comprehensive support and targeted support schools', 'COMPTRGTSUPSCHS')
		...
		([ColumnLength], [ColumnName], [DataType], [DisplayName], [XMLElementName])
		VALUES
		(15, 'TargetedSupportIdentificationTypeID','String', 'Targeted support identification', 'TRGTSUPIDFNTYP')
		...
		([FileSubmissionId], [FileColumnId], [EndPosition], [IsOptional], [SequenceNumber], [StartPosition])
		VALUES
		(@fileSubmissionId, @fileColumnId, 93, 'true', 8, 79)
