...
begin try
	...
	begin transaction
		...
		BEGIN
			...
			(CedsConnectionId, GenerateReportTypeId,GenerateReportControlTypeId,ShowCategorySetControl, ReportCode, ReportName, ReportShortName, IsActive)
			values
			( (select CedsConnectionId from App.CedsConnections where CedsConnectionName like '%C145%'),
		...
		BEGIN
			...
			UPDATE app.GenerateReports SET ReportName ='C145: MEP Services',	ReportShortName = 'C145' , IsActive ='1' WHERE GenerateReportId = @GenerateReportId
		END
		...
		BEGIN
			...
			UPDATE app.GenerateReports SET ReportName ='C151: Cohorts for Adjusted-Cohort Graduation Rate',	ReportShortName = 'C151' , IsActive ='1' WHERE GenerateReportId = @GenerateReportId
		END
		...
		BEGIN
			...
			(CedsConnectionId, GenerateReportTypeId,GenerateReportControlTypeId,ShowCategorySetControl, ReportCode, ReportName, ReportShortName, IsActive)
			values
			( (select CedsConnectionId from App.CedsConnections where CedsConnectionName like '%C165%'),
		...
		BEGIN
			...
			UPDATE app.GenerateReports SET ReportName ='C165: Migratory Data',	ReportShortName = 'C165' , IsActive ='1' WHERE GenerateReportId = @GenerateReportId
		END
		...
		BEGIN
			...
			(CedsConnectionId, GenerateReportTypeId,GenerateReportControlTypeId,ShowCategorySetControl, ReportCode, ReportName, ReportShortName, IsActive)
			values
			( (select CedsConnectionId from App.CedsConnections where CedsConnectionName like '%C193%'),
		...
		BEGIN
			...
			UPDATE app.GenerateReports SET ReportName ='C193: Title I Allocations',	ReportShortName = 'C193' , IsActive ='1' WHERE GenerateReportId = @GenerateReportId
		END
		...
		BEGIN
			...
			UPDATE app.GenerateReports SET ReportName ='C196: Management Organization for Charter Schools Roster',	ReportShortName = 'C196' , IsActive ='1' WHERE GenerateReportId = @GenerateReportId
		END
		...
		IF NOT EXISTS (select 1 from app.GenerateReports where ReportCode ='c035'  and GenerateReportTypeId = @generateReportTypeId)
		BEGIN
			INSERT into App.GenerateReports
			(CedsConnectionId, GenerateReportTypeId,GenerateReportControlTypeId,ShowCategorySetControl, ReportCode, ReportName, ReportShortName, IsActive)
			values
			( (select CedsConnectionId from App.CedsConnections where CedsConnectionName like '%C035%'),
			@generateReportTypeId, @GenerateReportControlTypeId, @ShowCategorySetControl, 'c035', 'C035: Federal Programs', 'C035', 1 )
 
			SET @GenerateReportId = CAST(SCOPE_IDENTITY() AS INT)
		END
		ELSE
		BEGIN
			select @GenerateReportId = GenerateReportId FROM App.GenerateReports Where ReportCode = 'c035' and GenerateReportTypeId = @generateReportTypeId
			UPDATE app.GenerateReports SET ReportName ='C035: Federal Programs',	ReportShortName = 'C035' , IsActive ='1' WHERE GenerateReportId = @GenerateReportId
		END
		...
		(@GenerateReportId, 2)
		  ...
		  Update app.CedsConnections set CedsUseCaseId = 2973 where CedsConnectionId = 61
		  Update app.CedsConnections set CedsUseCaseId = 2983 where CedsConnectionId = 60
		  Update app.CedsConnections set CedsUseCaseId = 3098 where CedsConnectionId = 113
		  Update app.CedsConnections set CedsUseCaseId = 3059 where CedsConnectionId = 70
