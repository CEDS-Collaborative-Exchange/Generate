...
BEGIN
	...
	--	isnull(idea.TitleIStatusCode, 'MISSING'),
		...
		ISNULL(studentStatus2.AcademicOrVocationalOutcomeCode,'MISSING'),
	...
	left outer join @NoDProgramStatus noDProgramStatus  on s.DimStudentId = noDProgramStatus.DimStudentId and s.DimCountDateId = noDProgramStatus.DimCountDateId and sch.DimSchoolId = noDProgramStatus.DimSchoolId
	...
	begin
		...
		and studentStatusesII.AcademicOrVocationalOutcomeCode = q.AcademicOrVocationalOutcomeCode
