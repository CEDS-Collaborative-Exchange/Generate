	...
	*************************************************************************************************************/
	BEGIN
		...
		(
			...
			WHERE EmapsQuestionAbbrv = 'MEMBERDTE' 
		), 'XX');
		...
		BEGIN TRY	
			...
			AND ps.PersonId IS NOT NULL
			AND ps.OrganizationID_LEA_Program_Foster IS NOT NULL
		END TRY
		...
		BEGIN TRY	
			...
			AND ps.ProgramType_FosterCare = 1
			AND ps.PersonId IS NOT NULL
			AND ps.OrganizationID_School_Program_Foster IS NOT NULL
		END TRY
		...
		BEGIN TRY	
			...
			AND ps.PersonId IS NOT NULL
			AND ps.OrganizationID_LEA_Program_Section504 IS NOT NULL
		END TRY
		...
		BEGIN TRY	
			...
			AND ps.ProgramType_Section504 = 1
			AND ps.PersonId IS NOT NULL
			AND ps.OrganizationID_School_Program_Section504 IS NOT NULL
		END TRY
...
-------------------------------------------------------
		...
		BEGIN TRY	
			...
			AND ps.PersonId IS NOT NULL
			AND ps.OrganizationID_LEA_Program_Immigrant IS NOT NULL
		END TRY
		...
		BEGIN TRY	
			...
			AND ps.ProgramType_Immigrant = 1
			AND ps.PersonId IS NOT NULL
			AND ps.OrganizationID_School_Program_Immigrant IS NOT NULL
		END TRY
...
-------------------------------------------------------
	...
	-----------------------------------------------------
		...
		BEGIN TRY	
			...
			AND ps.PersonId IS NOT NULL
			AND ps.OrganizationID_LEA_Program_Homeless IS NOT NULL
		END TRY
		...
		BEGIN TRY	
			...
			AND ps.HomelessServicedIndicator = 1
			AND ps.PersonId IS NOT NULL
			AND ps.OrganizationID_School_Program_Homeless IS NOT NULL
		END TRY
