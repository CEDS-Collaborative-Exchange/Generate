...
FROM    RDS.DimAeProgramEmploymentIndicators AS rdds CROSS JOIN
            ...
            Staging.SourceSystemReferenceData AS sssrd1 ON rdds.EmployedAfterExitCode = sssrd1.OutputCode AND sssrd1.TableFilter = '000988' AND rsy.SchoolYear = sssrd1.SchoolYear LEFT OUTER JOIN
            Staging.SourceSystemReferenceData AS sssrd2 ON rdds.EmployedWhileEnrolledCode = sssrd2.OutputCode AND sssrd2.TableFilter = '000987' AND rsy.SchoolYear = sssrd2.SchoolYear
