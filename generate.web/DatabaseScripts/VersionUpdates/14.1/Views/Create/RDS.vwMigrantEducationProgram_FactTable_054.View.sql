CREATE VIEW [RDS].[vwMigrantEducationProgram_FactTable_054] 
AS
	SELECT 	f.[FactK12StudentCountId]
			, f.[SchoolYear]
		  	...
		  	, f.[SchoolTypeCode]
			-- 14.1: FS054 dims GradeLevel / MigrantPrioritizedForServices / ContinuationOfServicesReason
			, f.[GradeLevelEdFactsCode]
			, f.[MigrantPrioritizedForServicesEdFactsCode]
			, f.[ContinuationOfServicesReasonCode] AS ContinuationOfServicesReasonEdFactsCode
