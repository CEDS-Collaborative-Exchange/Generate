CREATE VIEW [RDS].[vwMigrantEducationProgram_FactTable_145] 
AS
	SELECT 	f.[FactK12StudentCountId]
			, f.[SchoolYear]
		  	...
		  	, f.[SchoolTypeCode]
			-- 14.1: FS145 dims GradeLevel / MigrantEducationProgramServicesType
			, f.[GradeLevelEdFactsCode]
			, f.[MigrantEducationProgramServicesTypeEdFactsCode]
