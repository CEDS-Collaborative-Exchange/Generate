...
begin try
	...
	and dm.DataMigrationTypeCode = 'report'
		...
		begin	
			...
			-- 14.1: accommodations bridge renamed/redesigned to AccessibilityFeatures in 14.0
			delete from RDS.BridgeK12StudentAssessmentAccessibilityFeatures where FactK12StudentAssessmentId in (select factId from #factTable)
