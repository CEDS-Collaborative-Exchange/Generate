	...
	BEGIN TRY
		...
		WHEN MATCHED THEN
			Update SET trgt.Name = src.Name,							
						...
						trgt.IsApproverAgency = src.IsApproverAgency
		...
		INSERT([Name],StateIdentifier,StateCode,StateANSICode,[State],
				...
				RecordStartDateTime,RecordEndDateTime,IsApproverAgency)
		VALUES(src.[Name],src.StateIdentifier, StateCode, StateANSICode, [State],
				...
				src.RecordStartDateTime,src.RecordEndDateTime,'No');
