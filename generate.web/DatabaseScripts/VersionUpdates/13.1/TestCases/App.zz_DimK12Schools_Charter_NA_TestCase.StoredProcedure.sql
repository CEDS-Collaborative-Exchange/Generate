CREATE PROCEDURE [App].[zz_DimK12Schools_Charter_NA_TestCase]
...
BEGIN
	...
	--select distinct CharterSchoolStatus from rds.dimk12schoo	--TRUNCATE TABLE RDS.FactOrganizationCounts
	--TRUNCATE TABLE RDS.FactOrganizationStatusCounts
	--DELETE FROM RDS.BridgeK12SchoolGradeLevels
	--DELETE FROM RDS.BridgeLeaGradeLevels
	--DELETE FROM RDS.DimK12Schools
