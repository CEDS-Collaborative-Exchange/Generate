...
FROM [SQL01.EDMITS-AEM.COM,3748].[EDENDB].dbo.Category c
...
begin try
	...
	BEGIN
		INSERT INTO app.categories ( EdFactsCategoryId, CategoryCode, CategoryName) 
		VALUES (593, 'TITLEACT', 'English Learner Accountability')
	END
	ELSE
	BEGIN
		UPDATE app.categories SET CategoryCode = 'TITLEACT', CategoryName = 'English Learner Accountability'
	...
	BEGIN
		INSERT INTO app.categories ( EdFactsCategoryId, CategoryCode, CategoryName) 
		VALUES (605, 'COMPSUPIDFNTYP', 'Comprehensive Support and Improvement Type')
	END
	ELSE
	BEGIN
		UPDATE app.categories SET CategoryCode = 'COMPSUPIDFNTYP', CategoryName = 'Comprehensive Support and Improvement Type'
	...
	BEGIN
		INSERT INTO app.categories ( EdFactsCategoryId, CategoryCode, CategoryName) 
		VALUES (606, 'TRGTIDFNSBGRPS', 'Identification Subgroups')
	END
	ELSE
	BEGIN
		UPDATE app.categories SET CategoryCode = 'TRGTIDFNSBGRPS', CategoryName = 'Identification Subgroups'
	...
	insert into @recordIds (Id) values (613)
	IF NOT EXISTS (select 1 from app.categories where EdFactsCategoryId = 613)
	BEGIN
		INSERT INTO app.categories ( EdFactsCategoryId, CategoryCode, CategoryName) 
		VALUES (613, 'ASMTADMNSTRDELP', 'Assessment Administered (ELP)')
	END
	ELSE
	BEGIN
		UPDATE app.categories SET CategoryCode = 'ASMTADMNSTRDELP', CategoryName = 'Assessment Administered (ELP)'
		where EdFactsCategoryId = 613
	END
 
	insert into @recordIds (Id) values (614)
	IF NOT EXISTS (select 1 from app.categories where EdFactsCategoryId = 614)
	BEGIN
		INSERT INTO app.categories ( EdFactsCategoryId, CategoryCode, CategoryName) 
		VALUES (614, 'ELPROF5YRSTS', 'English Learners Proficiency Within Five Years Status')
	END
	ELSE
	BEGIN
		UPDATE app.categories SET CategoryCode = 'ELPROF5YRSTS', CategoryName = 'English Learners Proficiency Within Five Years Status'
		where EdFactsCategoryId = 614
	END
 
	insert into @recordIds (Id) values (615)
	IF NOT EXISTS (select 1 from app.categories where EdFactsCategoryId = 615)
	BEGIN
		INSERT INTO app.categories ( EdFactsCategoryId, CategoryCode, CategoryName) 
		VALUES (615, 'ELEXITSTS', 'English Learners Exited Status')
	END
	ELSE
	BEGIN
		UPDATE app.categories SET CategoryCode = 'ELEXITSTS', CategoryName = 'English Learners Exited Status'
		where EdFactsCategoryId = 615
	END
 
	insert into @recordIds (Id) values (616)
	IF NOT EXISTS (select 1 from app.categories where EdFactsCategoryId = 616)
	BEGIN
		INSERT INTO app.categories ( EdFactsCategoryId, CategoryCode, CategoryName) 
		VALUES (616, 'MAJORREGACCTBLY', 'Major Racial and Ethnic Groups (Accountability)')
	END
	ELSE
	BEGIN
		UPDATE app.categories SET CategoryCode = 'MAJORREGACCTBLY', CategoryName = 'Major Racial and Ethnic Groups (Accountability)'
		where EdFactsCategoryId = 616
	END
