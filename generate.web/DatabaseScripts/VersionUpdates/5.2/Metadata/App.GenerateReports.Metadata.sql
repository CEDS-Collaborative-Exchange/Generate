...
begin try
	...
	begin transaction
		...
		BEGIN
			...
			(CedsConnectionId, GenerateReportTypeId,GenerateReportControlTypeId,ShowCategorySetControl, ReportCode, ReportName, ReportShortName, IsActive)
			values
			( (select top 1 CedsConnectionId from App.CedsConnections where CedsConnectionName like '%C035%' OR CedsConnectionName like '%FS035%' order by CedsUseCaseId desc),
		...
		BEGIN
			...
			UPDATE app.GenerateReports SET ReportName ='C035: Federal Programs',	ReportShortName = 'C035' , IsActive ='1', 
			CedsConnectionId = 	 (select top 1 CedsConnectionId from App.CedsConnections where CedsConnectionName like '%C035%' OR CedsConnectionName like '%FS035%' order by CedsUseCaseId desc) 
			WHERE GenerateReportId = @GenerateReportId
		END
		...
		BEGIN
			...
			values
			( (select top 1 CedsConnectionId from App.CedsConnections where CedsConnectionName like '%C054%' OR CedsConnectionName like '%FS054%' order by CedsUseCaseId desc),
			@generateReportTypeId, @GenerateReportControlTypeId, @ShowCategorySetControl, 'c054', 'C054: MEP Students Served - 12 Months', 'C054', 1 )
		...
		BEGIN
			select @GenerateReportId = GenerateReportId FROM App.GenerateReports Where ReportCode = 'c054' and GenerateReportTypeId = @generateReportTypeId
			UPDATE app.GenerateReports SET ReportName ='C054: MEP Students Served - 12 Months',	ReportShortName = 'C054' , IsActive ='1', 
			CedsConnectionId = 	 (select top 1 CedsConnectionId from App.CedsConnections where CedsConnectionName like '%C054%' OR CedsConnectionName like '%FS054%' order by CedsUseCaseId desc) 
			WHERE GenerateReportId = @GenerateReportId
		END
		...
		BEGIN
			...
			@generateReportTypeId, @GenerateReportControlTypeId, @ShowCategorySetControl, 'c119', 'C119: N or D Participation - State Agency', 'C119', 1 )
		...
		BEGIN
			...
			UPDATE app.GenerateReports SET ReportName ='C119: N or D Participation - State Agency',	ReportShortName = 'C119' , IsActive ='1', 
		...
		BEGIN
			...
			values
			( (select top 1 CedsConnectionId from App.CedsConnections where CedsConnectionName like '%C165%' OR CedsConnectionName like '%FS165%' order by CedsUseCaseId desc),
			@generateReportTypeId, @GenerateReportControlTypeId, @ShowCategorySetControl, 'c165', 'C165: Migratory Data File', 'C165', 1 )
		...
		BEGIN
			select @GenerateReportId = GenerateReportId FROM App.GenerateReports Where ReportCode = 'c165' and GenerateReportTypeId = @generateReportTypeId
			UPDATE app.GenerateReports SET ReportName ='C165: Migratory Data File',	ReportShortName = 'C165' , IsActive ='1', 
			CedsConnectionId = 	 (select top 1 CedsConnectionId from App.CedsConnections where CedsConnectionName like '%C165%' OR CedsConnectionName like '%FS165%' order by CedsUseCaseId desc) 
			WHERE GenerateReportId = @GenerateReportId
		END
		...
		BEGIN
			...
			@generateReportTypeId, @GenerateReportControlTypeId, @ShowCategorySetControl, 'c181', 'C181: N or D Exited Program Outcomes', 'C181', 1 )
		...
		BEGIN
			...
			UPDATE app.GenerateReports SET ReportName ='C181: N or D Exited Program Outcomes',	ReportShortName = 'C181' , IsActive ='1', 
		...
		BEGIN
			...
			@generateReportTypeId, @GenerateReportControlTypeId, @ShowCategorySetControl, 'c209', 'C209: CTE Enrollment', 'C209', 1 )
		...
		BEGIN
			...
			UPDATE app.GenerateReports SET ReportName ='C209: CTE Enrollment',	ReportShortName = 'C209' , IsActive ='1', 
		...
		IF NOT EXISTS (select 1 from app.GenerateReports where ReportCode ='c213'  and GenerateReportTypeId = @generateReportTypeId)
		BEGIN
			INSERT into App.GenerateReports
			(CedsConnectionId, GenerateReportTypeId,GenerateReportControlTypeId,ShowCategorySetControl, ReportCode, ReportName, ReportShortName, IsActive)
			values
			( (select top 1 CedsConnectionId from App.CedsConnections where CedsConnectionName like '%C213%' OR CedsConnectionName like '%FS213%' order by CedsUseCaseId desc),
			@generateReportTypeId, @GenerateReportControlTypeId, @ShowCategorySetControl, 'c213', 'C213: CTE Concentrators in Extended Year Graduate Rate', 'C213', 1 )
 
			SET @GenerateReportId = CAST(SCOPE_IDENTITY() AS INT)
		END
		ELSE
		BEGIN
			select @GenerateReportId = GenerateReportId FROM App.GenerateReports Where ReportCode = 'c213' and GenerateReportTypeId = @generateReportTypeId
			UPDATE app.GenerateReports SET ReportName ='C213: CTE Concentrators in Extended Year Graduate Rate',	ReportShortName = 'C213' , IsActive ='1', 
			CedsConnectionId = 	 (select top 1 CedsConnectionId from App.CedsConnections where CedsConnectionName like '%C213%' OR CedsConnectionName like '%FS213%' order by CedsUseCaseId desc) 
			WHERE GenerateReportId = @GenerateReportId
		END
		...
		IF NOT EXISTS (select 1 from app.GenerateReports where ReportCode ='c214'  and GenerateReportTypeId = @generateReportTypeId)
		BEGIN
			INSERT into App.GenerateReports
			(CedsConnectionId, GenerateReportTypeId,GenerateReportControlTypeId,ShowCategorySetControl, ReportCode, ReportName, ReportShortName, IsActive)
			values
			( (select top 1 CedsConnectionId from App.CedsConnections where CedsConnectionName like '%C214%' OR CedsConnectionName like '%FS214%' order by CedsUseCaseId desc),
			@generateReportTypeId, @GenerateReportControlTypeId, @ShowCategorySetControl, 'c214', 'C214: CTE Concentrators Postsecondary Credential', 'C214', 1 )
 
			SET @GenerateReportId = CAST(SCOPE_IDENTITY() AS INT)
		END
		ELSE
		BEGIN
			select @GenerateReportId = GenerateReportId FROM App.GenerateReports Where ReportCode = 'c214' and GenerateReportTypeId = @generateReportTypeId
			UPDATE app.GenerateReports SET ReportName ='C214: CTE Concentrators Postsecondary Credential',	ReportShortName = 'C214' , IsActive ='1', 
			CedsConnectionId = 	 (select top 1 CedsConnectionId from App.CedsConnections where CedsConnectionName like '%C214%' OR CedsConnectionName like '%FS214%' order by CedsUseCaseId desc) 
			WHERE GenerateReportId = @GenerateReportId
		END
		...
		IF NOT EXISTS (select 1 from app.GenerateReports where ReportCode ='c216'  and GenerateReportTypeId = @generateReportTypeId)
		BEGIN
			INSERT into App.GenerateReports
			(CedsConnectionId, GenerateReportTypeId,GenerateReportControlTypeId,ShowCategorySetControl, ReportCode, ReportName, ReportShortName, IsActive)
			values
			( (select top 1 CedsConnectionId from App.CedsConnections where CedsConnectionName like '%C216%' OR CedsConnectionName like '%FS216%' order by CedsUseCaseId desc),
			@generateReportTypeId, @GenerateReportControlTypeId, @ShowCategorySetControl, 'c216', 'C216: CTE Concentrators Work-Based Learning', 'C216', 1 )
 
			SET @GenerateReportId = CAST(SCOPE_IDENTITY() AS INT)
		END
		ELSE
		BEGIN
			select @GenerateReportId = GenerateReportId FROM App.GenerateReports Where ReportCode = 'c216' and GenerateReportTypeId = @generateReportTypeId
			UPDATE app.GenerateReports SET ReportName ='C216: CTE Concentrators Work-Based Learning',	ReportShortName = 'C216' , IsActive ='1', 
			CedsConnectionId = 	 (select top 1 CedsConnectionId from App.CedsConnections where CedsConnectionName like '%C216%' OR CedsConnectionName like '%FS216%' order by CedsUseCaseId desc) 
			WHERE GenerateReportId = @GenerateReportId
		END
		...
		IF NOT EXISTS (select 1 from app.GenerateReports where ReportCode ='c217'  and GenerateReportTypeId = @generateReportTypeId)
		BEGIN
			INSERT into App.GenerateReports
			(CedsConnectionId, GenerateReportTypeId,GenerateReportControlTypeId,ShowCategorySetControl, ReportCode, ReportName, ReportShortName, IsActive)
			values
			( (select top 1 CedsConnectionId from App.CedsConnections where CedsConnectionName like '%C217%' OR CedsConnectionName like '%FS217%' order by CedsUseCaseId desc),
			@generateReportTypeId, @GenerateReportControlTypeId, @ShowCategorySetControl, 'c217', 'C217: CTE Concentrators Program Quality', 'C217', 1 )
 
			SET @GenerateReportId = CAST(SCOPE_IDENTITY() AS INT)
		END
		ELSE
		BEGIN
			select @GenerateReportId = GenerateReportId FROM App.GenerateReports Where ReportCode = 'c217' and GenerateReportTypeId = @generateReportTypeId
			UPDATE app.GenerateReports SET ReportName ='C217: CTE Concentrators Program Quality',	ReportShortName = 'C217' , IsActive ='1', 
			CedsConnectionId = 	 (select top 1 CedsConnectionId from App.CedsConnections where CedsConnectionName like '%C217%' OR CedsConnectionName like '%FS217%' order by CedsUseCaseId desc) 
			WHERE GenerateReportId = @GenerateReportId
		END
