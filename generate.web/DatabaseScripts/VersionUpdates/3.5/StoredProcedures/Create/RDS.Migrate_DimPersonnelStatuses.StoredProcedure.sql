...
BEGIN
	...
	where cred.IssuanceDate <= p.SubmissionYearDate and (cred.ExpirationDate is null or cred.ExpirationDate >= SubmissionYearDate)
	...
	inner join ods.OrganizationIdentifier oi on r.OrganizationId = oi.OrganizationId
