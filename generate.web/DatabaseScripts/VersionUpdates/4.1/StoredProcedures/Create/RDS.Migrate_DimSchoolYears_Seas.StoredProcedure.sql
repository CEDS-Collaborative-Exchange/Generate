CREATE PROCEDURE [RDS].[Migrate_DimSchoolYears_Seas]
	@dimSeaId as int,
	@dimSchoolYearId as int
AS
BEGIN
	...
	select distinct
		@dimSeaId,
		d.DimSchoolYearId,
		DATEFROMPARTS(d.SchoolYear, @childCountMonth, @childCountDay) as DateValue,
		d.SchoolYear,
		DATEFROMPARTS(d.SchoolYear, @referencePeriodStartMonth, @referencePeriodStartDay) as StartDate,
		DATEFROMPARTS(d.SchoolYear + 1, @referencePeriodEndMonth, @referencePeriodEndDay) as EndDate
	...
	and d.DimSchoolYearId = @dimSchoolYearId
