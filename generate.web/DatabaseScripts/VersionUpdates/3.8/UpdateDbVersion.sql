...
begin try
	...
	update App.GenerateConfigurations set GenerateConfigurationValue = '3.8' where GenerateConfigurationCategory = 'Database' and GenerateConfigurationKey = 'DatabaseVersion'
