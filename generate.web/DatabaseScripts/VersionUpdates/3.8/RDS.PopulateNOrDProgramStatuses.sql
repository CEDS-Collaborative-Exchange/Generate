					...
					BEGIN
							...
							begin
										...
										if not exists(select 1 from RDS.DimNOrDProgramStatuses where longtermstatusCode = @longtermstatusCode 
											and NeglectedOrDelinquentProgramTypeCode = @neglectedprogramtypeCode)
											begin
								...
								(
									...
									longtermstatusCode, longtermstatusDescription, longtermstatusEdFactsCode,
									NeglectedOrDelinquentProgramTypeCode, NeglectedOrDelinquentProgramTypeDescription, NeglectedOrDelinquentProgramTypeEdFactsCode
								)
								values
								(
								-1,
								@longtermstatusCode, @longtermstatusDescription, @longtermstatusEdFactsCode,
								@neglectedprogramtypeCode, @neglectedprogramtypeDescription, @neglectedprogramtypeEdFactsCode
								)
