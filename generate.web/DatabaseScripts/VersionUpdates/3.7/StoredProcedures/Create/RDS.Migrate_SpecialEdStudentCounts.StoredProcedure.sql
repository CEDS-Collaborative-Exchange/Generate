...
BEGIN
	...
	(
		DimStudentId,StudentPersonId,DimCountDateId,DimSchoolId,DimLeaId,DimSeaId,
		AgeCode,
		RaceCode,
	...
	left outer join @ageQuery a on s.DimStudentId = a.DimStudentId and s.DimCountDateId = a.DimCountDateId 
									...
									and sch.DimSchoolId = a.DimSchoolId and sch.DimLeaId = a.DimLeaId and sch.DimSeaId = a.DimSeaId
