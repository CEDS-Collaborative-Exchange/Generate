...
(
	...
	unique clustered (DimStudentId, DimSchoolId, DimCountDateId, DimLeaId, DimSeaId, OrganizationId)
)
AS
BEGIN
	...
	(
		...
		unique clustered (DimStudentId, PersonId, DimCountDateId, DimLeaId, DimSeaId, LeaOrganizationId,OrganizationPersonRoleId,OrganizationPersonRoleId_Parent)
	)
	...
	insert into @leaOrganizationData(DimStudentId, PersonId, DimCountDateId, DimLeaId, LeaOrganizationId,OrganizationPersonRoleId,OrganizationPersonRoleId_Parent, DimSeaId)
	...
	insert into @OrganizationData(DimStudentId, PersonId, DimCountDateId, DimSchoolId, DimLeaId, DimSeaId, OrganizationId, LeaOrganizationId)
