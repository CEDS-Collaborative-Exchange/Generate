...
begin try
	...
	begin transaction
		...
		BEGIN
			...
			(CedsConnectionId, GenerateReportTypeId,GenerateReportControlTypeId,ShowCategorySetControl, ReportCode, ReportName, ReportShortName, IsActive)
			values
			( (select CedsConnectionId from App.CedsConnections where CedsConnectionName like '%C032%'),
		...
		BEGIN
			...
			UPDATE app.GenerateReports SET ReportName ='C032: Dropouts',	ReportShortName = 'C032' , IsActive ='1' WHERE GenerateReportId = @GenerateReportId
		END
		...
		BEGIN
			...
			(CedsConnectionId, GenerateReportTypeId,GenerateReportControlTypeId,ShowCategorySetControl, ReportCode, ReportName, ReportShortName, IsActive)
			values
			( (select CedsConnectionId from App.CedsConnections where CedsConnectionName like '%C037%'),
		...
		BEGIN
			...
			UPDATE app.GenerateReports SET ReportName ='C037: Title I Part A SWP/TAS Participation',	ReportShortName = 'C037' , IsActive ='1' WHERE GenerateReportId = @GenerateReportId
		END
		...
		BEGIN
			...
			(CedsConnectionId, GenerateReportTypeId,GenerateReportControlTypeId,ShowCategorySetControl, ReportCode, ReportName, ReportShortName, IsActive)
			values
			( (select CedsConnectionId from App.CedsConnections where CedsConnectionName like '%C040%'),
		...
		BEGIN
			...
			UPDATE app.GenerateReports SET ReportName ='C040: Graduates/Completers',	ReportShortName = 'C040' , IsActive ='1' WHERE GenerateReportId = @GenerateReportId
		END
		...
		BEGIN
			...
			(CedsConnectionId, GenerateReportTypeId,GenerateReportControlTypeId,ShowCategorySetControl, ReportCode, ReportName, ReportShortName, IsActive)
			values
			( (select CedsConnectionId from App.CedsConnections where CedsConnectionName like '%C054%'),
		...
		BEGIN
			...
			UPDATE app.GenerateReports SET ReportName ='C054: MEP Students Served - 12 Month ',	ReportShortName = 'C054' , IsActive ='1' WHERE GenerateReportId = @GenerateReportId
		END
		...
		BEGIN
			...
			(CedsConnectionId, GenerateReportTypeId,GenerateReportControlTypeId,ShowCategorySetControl, ReportCode, ReportName, ReportShortName, IsActive)
			values
			( (select CedsConnectionId from App.CedsConnections where CedsConnectionName like '%C113%'),
		...
		BEGIN
			...
			UPDATE app.GenerateReports SET ReportName ='C113: N or D Academic Achievement - State Agency',	ReportShortName = 'C113' , IsActive ='1' WHERE GenerateReportId = @GenerateReportId
		END
		...
		BEGIN
			...
			(CedsConnectionId, GenerateReportTypeId,GenerateReportControlTypeId,ShowCategorySetControl, ReportCode, ReportName, ReportShortName, IsActive)
			values
			( (select CedsConnectionId from App.CedsConnections where CedsConnectionName like '%C119%'),
		...
		BEGIN
			...
			UPDATE app.GenerateReports SET ReportName ='C119: Neglected or Delinquent Participation (SEA)',	ReportShortName = 'C119' , IsActive ='1' WHERE GenerateReportId = @GenerateReportId
		END
		...
		BEGIN
			...
			(CedsConnectionId, GenerateReportTypeId,GenerateReportControlTypeId,ShowCategorySetControl, ReportCode, ReportName, ReportShortName, IsActive)
			values
			( (select CedsConnectionId from App.CedsConnections where CedsConnectionName like '%C125%'),
		...
		BEGIN
			...
			UPDATE app.GenerateReports SET ReportName ='C125: N or D Academic Achievement - LEA',	ReportShortName = 'C125' , IsActive ='1' WHERE GenerateReportId = @GenerateReportId
		END
		...
		BEGIN
			...
			(CedsConnectionId, GenerateReportTypeId,GenerateReportControlTypeId,ShowCategorySetControl, ReportCode, ReportName, ReportShortName, IsActive)
			values
			( (select CedsConnectionId from App.CedsConnections where CedsConnectionName like '%C127%'),
		...
		BEGIN
			...
			UPDATE app.GenerateReports SET ReportName ='C127: N or D - Participation (LEA)',	ReportShortName = 'C127' , IsActive ='1' WHERE GenerateReportId = @GenerateReportId
		END
		...
		BEGIN
			...
			(CedsConnectionId, GenerateReportTypeId,GenerateReportControlTypeId,ShowCategorySetControl, ReportCode, ReportName, ReportShortName, IsActive)
			values
			( (select CedsConnectionId from App.CedsConnections where CedsConnectionName like '%C134%'),
		...
		BEGIN
			...
			UPDATE app.GenerateReports SET ReportName ='C134: Title I Part A Participation',	ReportShortName = 'C134' , IsActive ='1' WHERE GenerateReportId = @GenerateReportId
		END
		...
		BEGIN
			...
			(CedsConnectionId, GenerateReportTypeId,GenerateReportControlTypeId,ShowCategorySetControl, ReportCode, ReportName, ReportShortName, IsActive)
			values
			( (select CedsConnectionId from App.CedsConnections where CedsConnectionName like '%C150%'),
		...
		BEGIN
			...
			UPDATE app.GenerateReports SET ReportName ='C150: Adjusted-Cohort Graduation Rate',	ReportShortName = 'C150' , IsActive ='1' WHERE GenerateReportId = @GenerateReportId
		END
		...
		BEGIN
			...
			(CedsConnectionId, GenerateReportTypeId,GenerateReportControlTypeId,ShowCategorySetControl, ReportCode, ReportName, ReportShortName, IsActive)
			values
			( (select CedsConnectionId from App.CedsConnections where CedsConnectionName like '%C151%'),
			@generateReportTypeId, @GenerateReportControlTypeId, @ShowCategorySetControl, 'c151', 'C151: Cohorts for Regulatory Adjusted-Cohort Graduation Rate', 'C151', 1 )
		...
		BEGIN
			...
			UPDATE app.GenerateReports SET ReportName ='C151: Cohorts for Regulatory Adjusted-Cohort Graduation Rate',	ReportShortName = 'C151' , IsActive ='1' WHERE GenerateReportId = @GenerateReportId
		END
		...
		BEGIN
			...
			(CedsConnectionId, GenerateReportTypeId,GenerateReportControlTypeId,ShowCategorySetControl, ReportCode, ReportName, ReportShortName, IsActive)
			values
			( (select CedsConnectionId from App.CedsConnections where CedsConnectionName like '%C180%'),
		...
		BEGIN
			...
			UPDATE app.GenerateReports SET ReportName ='C180: N or D In Program Outcomes',	ReportShortName = 'C180' , IsActive ='1' WHERE GenerateReportId = @GenerateReportId
		END
		...
		BEGIN
			...
			(CedsConnectionId, GenerateReportTypeId,GenerateReportControlTypeId,ShowCategorySetControl, ReportCode, ReportName, ReportShortName, IsActive)
			values
			( (select CedsConnectionId from App.CedsConnections where CedsConnectionName like '%C181%'),
		...
		BEGIN
			...
			UPDATE app.GenerateReports SET ReportName ='C181: N or D Exited Programs Outcomes',	ReportShortName = 'C181' , IsActive ='1' WHERE GenerateReportId = @GenerateReportId
		END
		...
		BEGIN
			...
			(CedsConnectionId, GenerateReportTypeId,GenerateReportControlTypeId,ShowCategorySetControl, ReportCode, ReportName, ReportShortName, IsActive)
			values
			( (select CedsConnectionId from App.CedsConnections where CedsConnectionName like '%C086%'),
		...
		BEGIN
			...
			UPDATE app.GenerateReports SET ReportName ='C086: Students Involved with Firearms',	ReportShortName = 'C086' , IsActive ='1' WHERE GenerateReportId = @GenerateReportId
		END
		...
		BEGIN
			...
			(CedsConnectionId, GenerateReportTypeId,GenerateReportControlTypeId,ShowCategorySetControl, ReportCode, ReportName, ReportShortName, IsActive)
			values
			( (select CedsConnectionId from App.CedsConnections where CedsConnectionName like '%C131%'),
		...
		BEGIN
			...
			UPDATE app.GenerateReports SET ReportName ='C131: LEA End of School Year Status',	ReportShortName = 'C131' , IsActive ='1' WHERE GenerateReportId = @GenerateReportId
		END
		...
		IF NOT EXISTS (select 1 from app.GenerateReports where ReportCode ='c086'  and CedsConnectionId is not null)
		BEGIN
		update app.GenerateReports set CedsConnectionId =(select CedsConnectionId from App.CedsConnections where CedsConnectionName like '%FS086%') where ReportCode='c086'
			
		END

		IF NOT EXISTS (select 1 from app.GenerateReports where ReportCode ='c131'  and CedsConnectionId is not null)
		BEGIN
		update app.GenerateReports set CedsConnectionId =(select CedsConnectionId from App.CedsConnections where CedsConnectionName like '%FS086%') where ReportCode='c086'
		...
		IF NOT EXISTS (select 1 from app.GenerateReports where ReportCode ='c131'  and CedsConnectionId is not null)
		BEGIN
			update app.GenerateReports set CedsConnectionId =(select CedsConnectionId from App.CedsConnections where CedsConnectionName like '%FS131%') where ReportCode='c131'
			
		END


		IF NOT EXISTS (select 1 from app.GenerateReports where ReportCode ='c160'  and CedsConnectionId is not null)
		BEGIN
		update app.GenerateReports set CedsConnectionId =(select CedsConnectionId from App.CedsConnections where CedsConnectionName like '%FS160%') where ReportCode='c160'
			
		END

		IF NOT EXISTS (select 1 from app.GenerateReports where ReportCode ='c199'  and CedsConnectionId is not null)
		BEGIN
		update app.GenerateReports set CedsConnectionId =(select CedsConnectionId from App.CedsConnections where CedsConnectionName like '%FS199%') where ReportCode='c199'
			
		END

		IF NOT EXISTS (select 1 from app.GenerateReports where ReportCode ='c150'  and CedsConnectionId is not null)
		BEGIN
		update app.GenerateReports set CedsConnectionId =(select CedsConnectionId from App.CedsConnections where CedsConnectionName like '%FS150%') where ReportCode='c150'
			
		END

		IF NOT EXISTS (select 1 from app.GenerateReports where ReportCode ='c151'  and CedsConnectionId is not null)
		BEGIN
		update app.GenerateReports set CedsConnectionId =(select CedsConnectionId from App.CedsConnections where CedsConnectionName like '%FS151%') where ReportCode='c151'
			
		END

		IF NOT EXISTS (select 1 from app.GenerateReports where ReportCode ='c163'  and CedsConnectionId is not null)
		BEGIN
		update app.GenerateReports set CedsConnectionId =(select CedsConnectionId from App.CedsConnections where CedsConnectionName like '%FS163%') where ReportCode='c163'
