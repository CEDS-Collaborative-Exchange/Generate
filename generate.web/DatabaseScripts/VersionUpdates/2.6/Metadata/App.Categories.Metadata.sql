...
begin try
	...
	BEGIN
		INSERT INTO app.categories ( EdFactsCategoryId, CategoryCode, CategoryName) 
		VALUES (214, 'LEPPERKINS', 'LEP Status (Perkins)')
	END
	ELSE
	BEGIN
		UPDATE app.categories SET CategoryCode = 'LEPPERKINS', CategoryName = 'LEP Status (Perkins)'
	...
	BEGIN
		INSERT INTO app.categories ( EdFactsCategoryId, CategoryCode, CategoryName) 
		VALUES (240, 'ACADVOCOUTCOME', 'Academic / Vocational Outcomes')
	END
	ELSE
	BEGIN
		UPDATE app.categories SET CategoryCode = 'ACADVOCOUTCOME', CategoryName = 'Academic / Vocational Outcomes'
	...
	BEGIN
		INSERT INTO app.categories ( EdFactsCategoryId, CategoryCode, CategoryName) 
		VALUES (579, 'ACADVOCOUTCOME', 'Academic / Vocational Outcomes (Exit)')
	END
	ELSE
	BEGIN
		UPDATE app.categories SET CategoryCode = 'ACADVOCOUTCOME', CategoryName = 'Academic / Vocational Outcomes (Exit)'
	...
	BEGIN
		INSERT INTO app.categories ( EdFactsCategoryId, CategoryCode, CategoryName) 
		VALUES (589, 'INEXPSTATUS', 'Inexperienced Status')
	END
	ELSE
	BEGIN
		UPDATE app.categories SET CategoryCode = 'INEXPSTATUS', CategoryName = 'Inexperienced Status'
	...
	BEGIN
		INSERT INTO app.categories ( EdFactsCategoryId, CategoryCode, CategoryName) 
		VALUES (590, 'EMGCREDSTATUS', 'Emergency or Provisional Credential Status')
	END
	ELSE
	BEGIN
		UPDATE app.categories SET CategoryCode = 'EMGCREDSTATUS', CategoryName = 'Emergency or Provisional Credential Status'
	...
	BEGIN
		INSERT INTO app.categories ( EdFactsCategoryId, CategoryCode, CategoryName) 
		VALUES (591, 'OOFIELDSTATUS', 'Out of Field Status')
	END
	ELSE
	BEGIN
		UPDATE app.categories SET CategoryCode = 'OOFIELDSTATUS', CategoryName = 'Out of Field Status'
