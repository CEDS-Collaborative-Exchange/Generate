...
BEGIN
	...
	DROP TABLE IF EXISTS #C002Staging
	DROP TABLE IF EXISTS #S_CSA
	DROP TABLE IF EXISTS #S_CSB
	DROP TABLE IF EXISTS #S_CSC
	DROP TABLE IF EXISTS #S_CSD
	DROP TABLE IF EXISTS #S_CSE

	DROP TABLE IF EXISTS #L_CSA
	DROP TABLE IF EXISTS #L_CSB
	DROP TABLE IF EXISTS #L_CSC
	DROP TABLE IF EXISTS #L_CSD
	DROP TABLE IF EXISTS #L_CSE

	DROP TABLE IF EXISTS #S_TOT1
	DROP TABLE IF EXISTS #S_TOT2
	DROP TABLE IF EXISTS #S_TOT3
	DROP TABLE IF EXISTS #S_TOT4
	DROP TABLE IF EXISTS #S_TOT5
	DROP TABLE IF EXISTS #S_TOT6
	DROP TABLE IF EXISTS #S_TOT7
	DROP TABLE IF EXISTS #S_TOT

	DROP TABLE IF EXISTS #L_TOT1
	DROP TABLE IF EXISTS #L_TOT2
	DROP TABLE IF EXISTS #L_TOT3
	DROP TABLE IF EXISTS #L_TOT4
	DROP TABLE IF EXISTS #L_TOT5
	DROP TABLE IF EXISTS #L_TOT6
	DROP TABLE IF EXISTS #L_TOT7
	DROP TABLE IF EXISTS #L_TOT
...
--/***********************************************************
	 ...
	 SELECT  
		...
		JOIN Staging.PersonStatus idea
			...
			AND (
				(ske.LEA_Identifier_State = idea.LEA_Identifier_State AND ske.School_Identifier_State = idea.School_Identifier_State)
				or (ske.LEA_Identifier_State = idea.LEA_Identifier_State AND ske.School_Identifier_State is null)
				)
		...
		JOIN Staging.ProgramParticipationSpecialEducation sppse
			...
			AND (
				(ske.LEA_Identifier_State = sppse.LEA_Identifier_State AND ske.School_Identifier_State = sppse.School_Identifier_State)
				or (ske.LEA_Identifier_State = idea.LEA_Identifier_State AND ske.School_Identifier_State is null)
				)
		...
		left JOIN Staging.PersonStatus el 
			...
			AND (
				(ske.LEA_Identifier_State = el.LEA_Identifier_State AND ske.School_Identifier_State = el.School_Identifier_State)
				or (ske.LEA_Identifier_State = el.LEA_Identifier_State AND ske.School_Identifier_State is null)
				)
