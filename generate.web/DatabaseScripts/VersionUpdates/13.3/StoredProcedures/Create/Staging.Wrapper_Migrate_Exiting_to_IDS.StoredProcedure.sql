...
BEGIN
	...
	--Populate the IDS tables from Staging data
		...
		--write out message to DataMigrationHistories
		insert into app.DataMigrationHistories
		(DataMigrationHistoryDate, DataMigrationTypeId, DataMigrationHistoryMessage) values	(getutcdate(), 1, 'IDS Migration Wrapper Exiting - Start ProgramParticipationCte')

		--Populate ProgramParticipationCTE
