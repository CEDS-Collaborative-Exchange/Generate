...
FROM    RDS.DimAeProgramParticipantGoals AS rdds CROSS JOIN
            ...
            Staging.SourceSystemReferenceData AS sssrd1 ON rdds.GoalsForAttendingAdultEducationCode = sssrd1.OutputCode AND sssrd1.TableFilter = '001940' AND rsy.SchoolYear = sssrd1.SchoolYear
