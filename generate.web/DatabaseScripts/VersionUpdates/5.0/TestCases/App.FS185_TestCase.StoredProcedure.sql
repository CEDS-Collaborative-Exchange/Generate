CREATE OR ALTER PROCEDURE [App].[FS185_TestCase]	
	@SchoolYear SMALLINT
AS
BEGIN
...
BEGIN TRY
	...
	DECLARE @UnitTestName VARCHAR(100) = 'FS185_UnitTestCase'
	DECLARE @AssessmentAcademicSubject VARCHAR(10) = '01166' 
	DECLARE @StoredProcedureName VARCHAR(100) = 'FS185_TestCase'
	DECLARE @TestScope VARCHAR(1000) = 'FS185'
	DECLARE @ReportCode VARCHAR(20) = 'C185' 
	...
	CREATE NONCLUSTERED INDEX IX_asr ON #asr (Student_Identifier_State,LEA_Identifier_State,School_Identifier_State,SchoolYear,GradeLevelWhenAssessed,AssessmentTitle,AssessmentAcademicSubject,AssessmentPurpose,AssessmentRegistrationParticipationIndicator,AssessmentRegistrationReasonNotCompleting,AssessmentTypeAdministeredToChildrenWithDisabilities)
