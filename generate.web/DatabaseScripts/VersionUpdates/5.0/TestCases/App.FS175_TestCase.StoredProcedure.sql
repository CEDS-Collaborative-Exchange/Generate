CREATE OR ALTER PROCEDURE [App].[FS175_TestCase]	
	@SchoolYear SMALLINT
AS
BEGIN
...
,sy.SessionEndDate
	...
	INNER JOIN #ske ske
		ON asr.Student_Identifier_State = ske.Student_Identifier_State
	AND asr.LEA_Identifier_State = ske.LEA_Identifier_State
	AND asr.School_Identifier_State = ske.School_Identifier_State
	INNER JOIN #sy sy
	...
	LEFT JOIN #sps idea
		ON idea.Student_Identifier_State = asr.Student_Identifier_State
		   AND idea.LEA_Identifier_State = asr.LEA_Identifier_State
		   AND idea.School_Identifier_State = asr.School_Identifier_State
     ...
     LEFT JOIN #sps el
		ON el.Student_Identifier_State = asr.Student_Identifier_State
		   AND el.LEA_Identifier_State = asr.LEA_Identifier_State
		   AND el.School_Identifier_State = asr.School_Identifier_State
     ...
     LEFT JOIN #sps eco
		ON eco.Student_Identifier_State = asr.Student_Identifier_State
		   AND eco.LEA_Identifier_State = asr.LEA_Identifier_State
		   AND eco.School_Identifier_State = asr.School_Identifier_State
     ...
     LEFT JOIN #sps ms
		ON ms.Student_Identifier_State = asr.Student_Identifier_State
		   AND ms.LEA_Identifier_State = asr.LEA_Identifier_State
		   AND ms.School_Identifier_State = asr.School_Identifier_State
     ...
     LEFT JOIN #sps hs
		ON hs.Student_Identifier_State = asr.Student_Identifier_State
		   AND hs.LEA_Identifier_State = asr.LEA_Identifier_State
		   AND hs.School_Identifier_State = asr.School_Identifier_State
     ...
     LEFT JOIN #sps fc
		ON fc.Student_Identifier_State = asr.Student_Identifier_State
		   AND fc.LEA_Identifier_State = asr.LEA_Identifier_State
		   AND fc.School_Identifier_State = asr.School_Identifier_State
     ...
     LEFT JOIN #sps mcs
		ON mcs.Student_Identifier_State = asr.Student_Identifier_State
		   AND mcs.LEA_Identifier_State = asr.LEA_Identifier_State
		   AND mcs.School_Identifier_State = asr.School_Identifier_State
	...
	LEFT JOIN staging.ProgramParticipationSpecialEducation ppse
		ON ppse.Student_Identifier_State = asr.Student_Identifier_State
		   AND ppse.LEA_Identifier_State = asr.LEA_Identifier_State
		   AND ppse.School_Identifier_State = asr.School_Identifier_State
	INNER JOIN #ds ds
