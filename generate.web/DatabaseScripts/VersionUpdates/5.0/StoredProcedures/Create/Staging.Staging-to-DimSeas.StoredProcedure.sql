...
BEGIN
	...
	( 
		...
		LEFT JOIN Staging.OrganizationAddress smap
			...
			AND smap.OrganizationType = orgTypes.SeaOrganizationType
	...
	WHEN MATCHED THEN 
		UPDATE SET 
			...
			, [Telephone]					 = src.[SeaContact_PhoneNumber]
	...
	UPDATE sea SET RecordEndDateTime = upd.RecordEndDateTime -1 
