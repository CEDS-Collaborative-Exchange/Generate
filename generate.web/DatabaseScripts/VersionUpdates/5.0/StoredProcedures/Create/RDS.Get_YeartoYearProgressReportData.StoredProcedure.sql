...
BEGIN
	...
	select @selectedYear = SchoolYear from rds.DimSchoolYears where SchoolYear = @reportYear

	select @submissionYears = COALESCE(@submissionYears + ',', '') + Quotename(SchoolYear, '''') 
