...
{
    public class EdFactsBrowserFixture : IDisposable
    {
        ...
        public EdFactsBrowserFixture()
        {
            ...
            var linkElement = waitFor60seconds.Until(ExpectedConditions.ElementToBeClickable(By.Id("link_ReportsEdFacts")));
            linkElement.Click();
        }
