...
The Generate Submission File Comparison Utility (“Comparison Utility”) provides tools to load legacy EDFacts files into SQL tables, then compares the Generate versions of those same files to the legacy file to identify differences. For more information on how to utilize this tool to verify counts, review the [File Comparison](../../generate-utilities/file-comparison/) steps under Generate Utilities.
...
<figure><img src="../../../.gitbook/assets/Programmability Image.jpg" alt="SQL Server Management Studio Object Explorer with Stored Procedures expanded."><figcaption><p>Expand Stored Procedures in SQL Server Management Studio.</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/Execute Stored Procedure Image.jpg" alt="RDS.Create_ReportData context menu with Execute Stored Procedure selected."><figcaption><p>Run the RDS.Create_ReportData stored procedure.</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/RDS.Create_ReportData.jpg" alt="Execute Procedure dialog with report migration parameters."><figcaption><p>Enter the report migration parameters before executing the procedure.</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/Run Stored Procedure as Test Messages.jpg" alt="SQL Server Management Studio results showing generated report migration code."><figcaption><p>Generated report migration code appears in the results panel.</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/Block of Code - Format.jpg" alt="Report migration code with Create Debugging Tables and insert sections."><figcaption><p>Review the debugging-table and insert sections before running the code.</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/Metadata Block.jpg" alt="Report migration metadata block that creates temporary tables."><figcaption><p>The metadata block creates temporary tables for the selected category set.</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/Actual Counts query Image.jpg" alt="Report migration rules subquery."><figcaption><p>The rules subquery selects students included in the report.</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/SELECT Statement Review Image.jpg" alt="Report migration SELECT statement that aggregates report counts."><figcaption><p>The final SELECT statement aggregates the report counts.</p></figcaption></figure>
