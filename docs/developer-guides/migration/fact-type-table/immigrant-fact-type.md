...
<figure><img src="../../../.gitbook/assets/image (228).png" alt="SQL Server Management Studio showing the Source-to-Staging Immigrant stored procedure placeholder."><figcaption><p>Source-to-Staging procedure placeholder.</p></figcaption></figure>
...
{% code overflow="wrap" %}
```sql
exec [Staging].[Staging-to-FactK12StudentCounts_Immigrant] 2026, '123456789', 1
```
{% endcode %}
