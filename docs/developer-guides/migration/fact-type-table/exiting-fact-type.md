...
```
/****** Object:  StoredProcedure [Source].[Source-to-Staging_Exiting]    Script Date: 8/18/2025 10:12:03 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [Source].[Source-to-Staging_Exiting] 
	@schoolYear smallint
AS
--BEGIN
...
{% code overflow="wrap" %}
```sql
exec [Staging].[Staging-to-FactK12StudentCounts_Existing] 2026, '123456789', 1
```
{% endcode %}
