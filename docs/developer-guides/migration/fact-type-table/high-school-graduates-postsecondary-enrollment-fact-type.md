...
<figure><img src="../../../.gitbook/assets/image (227).png" alt="SQL Server Management Studio showing the Source-to-Staging High School Graduates Postsecondary Enrollment stored procedure placeholder."><figcaption><p>Screenshot of the Generate database structure in SQL Server Management Studio, showing a stored procedure placeholder for the "Source-to-Staging_(Fact Type Name)" Fact Type.</p></figcaption></figure>
...
{% code overflow="wrap" %}
```sql
exec [Staging].[Staging-to-FactK12StudentCounts_HSGradPSEnroll] 2026, '123456789', 1
```
{% endcode %}
