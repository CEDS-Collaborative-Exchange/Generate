...
<div data-full-width="true"><figure><img src="../../.gitbook/assets/1 - Data Store Home.png" alt="Data Store page with Staging, RDS, and Reports Migration options."><figcaption><p>The three Migration process choices a Generate Admin can make are <strong>Staging Migration</strong>, <strong>RDS Migration</strong>, <strong>Reports Migration</strong>.</p></figcaption></figure></div>
...
<figure><img src="../../.gitbook/assets/image (16).png" alt="Data Store migration options with an arrow pointing to the Staging Migration button." width="452"><figcaption><p>Data Store Migration Selection Buttons</p></figcaption></figure>

This opens the **Staging Migration** page.

<div data-full-width="true"><figure><img src="../../.gitbook/assets/image (15).png" alt="Staging Migration page with school year and task selections."><figcaption><p>Staging Migration School Years and Staging Migration Tasks</p></figcaption></figure></div>
...
![Selected school year checkbox on the Staging Migration page.](<../../.gitbook/assets/image (133).png>)

2. To disable a school year’s migration to Staging, deselect the checkbox next to the school year.

![Cleared school year checkbox on the Staging Migration page.](<../../.gitbook/assets/image (78).png>)
...
<div data-full-width="true"><figure><img src="../../.gitbook/assets/image (17).png" alt="Staging Migration page with the Enabled column highlighted for stored procedures."><figcaption><p>Staging Migration School Years and Staging Migration Tasks with Enabled column highlighted</p></figcaption></figure></div>
...
<div data-full-width="true"><figure><img src="../../.gitbook/assets/image (18).png" alt="Staging Migration page with the Execution Order column highlighted."><figcaption><p>Staging Migration School Years and Staging Migration Tasks with Execution Order column highlighted</p></figcaption></figure></div>
...
<div data-full-width="true"><figure><img src="../../.gitbook/assets/image (19).png" alt="Staging Migration page with an arrow pointing to the Migrate to Staging button."><figcaption><p>Staging Migration School Years, Tasks, and Migrate buttons with arrow pointing to "Migrate" button</p></figcaption></figure></div>
...
<figure><img src="../../.gitbook/assets/image (20).png" alt="Data Store migration options with an arrow to RDS Migration."><figcaption><p>Data Store Migration Selection Buttons with arrow to RDS Migration button</p></figcaption></figure>

This opens the RDS Migration page.

<figure><img src="../../.gitbook/assets/image (72).png" alt="RDS Migration page with school year and task selections."><figcaption><p>RDS Migration page</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (87).png" alt="RDS Migration page with the Enabled column highlighted for wrapper stored procedures."><figcaption><p>RDS Migration School Years and RDS Migration Tasks with Enabled column highlighted</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (81).png" alt="RDS Migration task list with selected and unselected stored procedure checkboxes highlighted."><figcaption><p>RDS Migration School Years and RDS Migration Tasks with all columns highlighted</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (121).png" alt="RDS Migration page with an arrow pointing to the Migrate to Reporting Data Store button."><figcaption><p>RDS Migration School Years and RDS Migration Tasks with arrow pointing to "Migrate" button</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (21).png" alt="Data Store migration options with an arrow to Reports Migration."><figcaption><p>Data Store Migration Selection Buttons with arrow to Report Migration button</p></figcaption></figure>

This opens the Report Migration page.

<figure><img src="../../.gitbook/assets/image (102).png" alt="Reports Migration page with school year and report task selections."><figcaption><p>Reports Migration School Years and Reports Migration Tasks</p></figcaption></figure>
...
![Reports Migration school year dropdown.](<../../.gitbook/assets/image (82).png>)
...
<figure><img src="../../.gitbook/assets/image (153).png" alt="Reports Migration task list with the C002 report row highlighted."><figcaption><p>Report Migration Tasks w/ C002 row highlighted</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (150).png" alt="Reports Migration page with the Migrate to Report Data Store and Go to Data Store buttons highlighted."><figcaption><p>Report Migration Tasks with "Migrate" and "GO TO DATA STORE" buttons highlighted</p></figcaption></figure>
