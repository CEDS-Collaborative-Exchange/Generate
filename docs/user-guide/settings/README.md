...
<figure><img src="../../.gitbook/assets/image (111).png" alt="Generate navigation bar with the Settings gear button highlighted."><figcaption><p>Settings button</p></figcaption></figure>
