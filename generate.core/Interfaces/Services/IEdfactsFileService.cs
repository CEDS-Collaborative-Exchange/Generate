...
namespace generate.core.Interfaces.Services
{
    public interface IEdfactsFileService
    {
        ...
        List<ExpandoObject> GetSubmissionData(dynamic dataRows, List<FileSubmissionColumnDto> fileSubmissioncolumns, string factTableName, string reportCode, string reportLevel);
