...
namespace generate.core.Interfaces.Repositories.RDS
{
    public interface IFactOrganizationCountRepository : IRDSRepository
    {
        ...
        IEnumerable<ReportEDFactsOrganizationCount> Get_ReportData(string reportCode, string reportLevel, string reportYear, string categorySetCode, bool includeZeroCounts = false, bool includeFriendlyCaptions = false, bool obscureMissingCategoryCounts = false, bool flag = false);
