...
{
    public partial class RefGunFreeSchoolsActReportingStatus
    {
        public RefGunFreeSchoolsActReportingStatus()
        {
            OrganizationFederalAccountability = new HashSet<OrganizationFederalAccountability>();
        }

        public int RefGunFreeSchoolsActStatusReportingId { get; set; }
