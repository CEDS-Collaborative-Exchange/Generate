...
{
    public partial class FactOrganizationCountReportDto
    {
        public int FactOrganizationCountReportDtoId { get; set; }
        ...
        public string TitleiParentalInvolveRes { get; set; }
        public string TitleiPartaAllocations { get; set; }
